...
Jeho role přesahuje pouhé směrování požadavků. HGMLC je zodpovědný za korelaci účtování pro lokalizační transakce, vede záznamy pro audit a podporuje odložené lokalizační požadavky (např. periodické nebo spouštěné hlášení polohy). V kontextu 5G jsou funkce HGMLC integrovány do architektury Location Management Function (LMF) a Network Exposure Function (NEF), ale logické oddělení odpovědností mezi domovskou a navštívenou sítí zůstává klíčovým konceptem pro scénáře mezi operátory a roaming.
...
- [VGMLC – Visited Gateway Mobile Location Centre](/mobilnisite/slovnik/vgmlc/)
