...
ORPK byl zaveden, aby řešil rostoucí potřebu bezpečného, ověřeného provizionování a řízení mobilních zařízení jejich domovskými síťovými operátory. Před takovými mechanismy založenými na PKI se řízení chování zařízení pro výběr sítě nebo konfiguraci služeb více spoléhalo na méně bezpečné metody nebo implicitní důvěru, které byly zranitelné vůči falšování a manipulaci. S vývojem sítí a rostoucí složitostí zařízení se zvýšilo riziko škodlivého přesměrování (např. navedení zařízení na falešnou základnovou stanici) nebo neoprávněných konfiguračních změn.
