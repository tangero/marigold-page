...
Architektonicky existují ADU na rozhraní mezi aplikační vrstvou a podpůrnými transportními protokoly. Když aplikace generuje obsah, zabalí mediální data do ADU, z nichž každé má definovaný časový razítko prezentace (PTS) a časové razítko dekódování ([DTS](/mobilnisite/slovnik/dts/)), které určují, kdy má být obsah dekódován a zobrazen. Tyto ADU jsou poté předány transportním protokolům, jako je [RTP](/mobilnisite/slovnik/rtp/) (Real-time Transport Protocol) pro streamování nebo [FLUTE](/mobilnisite/slovnik/flute/) (File Delivery over Unidirectional Transport) pro doručování souborů, které mohou ADU dále segmentovat nebo paketizovat pro přenos sítí. Specifikace služeb 3GPP Packet-switched Streaming Service ([PSS](/mobilnisite/slovnik/pss/)) a Multimedia Broadcast/Multicast Service (MBMS) definují, jak se ADU mapují na transportní protokoly, s konkrétními pravidly pro fragmentaci a opětovné sestavení, když velikost ADU překročí omezení maximální přenosové jednotky.
