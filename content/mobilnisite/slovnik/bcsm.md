...
Historicky byl koncept BCSM převzat z pevných standardů Inteligentní sítě ([ITU-T](/mobilnisite/slovnik/itu-t/) CS-1) a přizpůsoben 3GPP pro mobilní sítě, nejvýznamněji v rámci frameworku [CAMEL](/mobilnisite/slovnik/camel/) pro GSM a UMTS. Poskytl základní mechanismus pro implementaci operátorsky specifické, reálné kontroly nad mobilními hovory a relacemi, což bylo zásadní pro pokročilé účtovací schémata (jako předplacené), služby založené na poloze a personalizované zacházení s hovory – služby, které se stávaly klíčovými konkurenčními rozdíly pro mobilní operátory.
