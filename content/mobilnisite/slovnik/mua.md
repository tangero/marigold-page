...
Modify UE Context Answer (MUA) je příkaz protokolu Diameter (konkrétně zpráva typu Diameter Answer) definovaný na referenčních bodech Gx a Sd v rámci architektury 3GPP Policy and Charging Control (PCC). Funguje jako odpověď na Modify UE Context Request ([MUR](/mobilnisite/slovnik/mur/)). Hlavními aktéry jsou Policy and Charging Rules Function (PCRF), která MUA odesílá, a Traffic Detection Function (TDF) nebo Policy and Charging Enforcement Function (PCEF) rozšířená o schopnosti Application Detection and Control ([ADC](/mobilnisite/slovnik/adc/)), která ji přijímá. Tato výměna je součástí dynamického řízení relace politiky.
