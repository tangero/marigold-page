...
Z architektonického hlediska je ESC typicky implementován jako součást Presence Serveru nebo vyhrazeného aplikačního serveru ([AS](/mobilnisite/slovnik/as/)) v doméně IMS. Rozhraní využívá protokol Session Initiation Protocol ([SIP](/mobilnisite/slovnik/sip/)) pro publikaci a odběr událostí, jak je definováno v [RFC](/mobilnisite/slovnik/rfc/) 3856 (Přítomnost) a RFC 6665 (SIP-Specific Event Notification). ESC přijímá požadavky PUBLISH obsahující dokumenty stavu události (např. ve formátu [PIDF](/mobilnisite/slovnik/pidf/)) od Presence User Agents ([PUA](/mobilnisite/slovnik/pua/)), které mohou sídlit na uživatelském zařízení, síťové službě nebo jiných aplikacích. Každý PUA může publikovat pouze částečný pohled na celkový stav uživatele (např. stav zařízení, dostupnost z kalendáře, síťová registrace).
...
- [PUA – Presence User Agent](/mobilnisite/slovnik/pua/)
