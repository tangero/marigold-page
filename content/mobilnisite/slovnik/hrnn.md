...
Human Readable Network Name (HRNN, uživatelsky čitelný název sítě) je síťový identifikátor definovaný ve specifikacích 3GPP pro uživatelsky přívětivé vyhledávání a výběr sítě. Jedná se o řetězec znaků kódovaný v [UTF-8](/mobilnisite/slovnik/utf-8/), který reprezentuje název sítě, například značku veřejného operátora (např. „Operator A 5G“) nebo privátní/podnikovou síť (např. „Factory Campus Network“). HRNN je vysílán sítí v blocích systémových informací ([SIB](/mobilnisite/slovnik/sib/)) přes rádiové rozhraní a je používán UE k prezentaci dostupných sítí uživateli srozumitelným způsobem. Z architektonické perspektivy je HRNN asociován s [PLMN](/mobilnisite/slovnik/plmn/) ID ([MCC](/mobilnisite/slovnik/mcc/)+[MNC](/mobilnisite/slovnik/mnc/)) nebo s Network Identifier ([NID](/mobilnisite/slovnik/nid/)) pro [SNPN](/mobilnisite/slovnik/snpn/) (Standalone Non-Public Network). Funguje v rámci procedur Non-Access Stratum ([NAS](/mobilnisite/slovnik/nas/)) a Access Stratum (AS) pro výběr a registraci sítě.

Mechanismus funguje následovně: Síť (gNB v 5G NR nebo eNB v LTE) zahrnuje HRNN do specifických zpráv systémových informací, jako je SIB1. Když UE provádí počáteční výběr buňky nebo skenuje dostupné sítě, přečte tyto vysílané zprávy. Vrstva NAS v UE přijme HRNN spolu s PLMN ID/NID. Řídící vrstva (MM) zařízení nebo uživatelské rozhraní pak použije tento HRNN k naplnění seznamu dostupných sítí zobrazeného uživateli. Pro automatický výběr sítě může UE použít PLMN ID ze svého seznamu preferovaných sítí, ale HRNN zlepšuje zážitek z manuálního výběru. V případě neveřejných sítí (NPN) je HRNN obzvláště důležitý, protože tyto sítě nemusí mít globálně unikátní PLMN ID a jsou určeny pro privátní použití; rozeznatelný název je nezbytný, aby uživatelé dokázali identifikovat a připojit se ke správné privátní síti v prostředích, kde může být přítomno více takových sítí.
