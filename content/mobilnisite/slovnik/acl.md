...
Tato technologie řeší problém udržení integrity dat na náchylných bezdrátových kanálech při efektivním sdílení šířky pásma se synchronními hlasovými spojeními. Předchozí řešení bezdrátového přenosu dat buď postrádala správnou opravu chyb, nebo používala neefektivní schémata opakovaného vysílání, která degradovala celkový výkon sítě. Kombinace ARQ, FEC a flexibilních typů paketů v ACL poskytuje přizpůsobitelnou ochranu proti chybám vhodnou pro různé typy dat a podmínky kanálu.
