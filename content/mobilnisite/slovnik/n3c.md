...
Non-3GPP Connection (N3C) je protokolová podvrstva zavedená v architektuře protokolu uživatelské roviny 5G New Radio (NR), která funguje mezi vrstvami Service Data Adaptation Protocol ([SDAP](/mobilnisite/slovnik/sdap/))/Packet Data Convergence Protocol ([PDCP](/mobilnisite/slovnik/pdcp/)) a podléhající spojovou vrstvu přístupové technologie mimo 3GPP. Funguje jako adaptační vrstva, která umožňuje horním vrstvám zásobníku 5G radiového protokolu (konkrétně PDCP) pracovat nezávisle na vlastnostech spodní vrstvy rádiového spoje mimo 3GPP. Entita N3C je umístěna jak v uživatelském zařízení (UE), tak na straně sítě (např. v gNB-CU nebo v dedikovaném uzlu podporujícím více přístupových technologií). Jejím hlavním úkolem je mapovat PDCP Protocol Data Units ([PDU](/mobilnisite/slovnik/pdu/)) na služební datové jednotky spojové vrstvy spoje mimo 3GPP a řešit aspekty jako segmentaci, opětovné sestavení a doručování v pořadí, pokud tento spoj tyto služby nativně neposkytuje.
