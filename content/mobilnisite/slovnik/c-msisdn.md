...
C-MSISDN je klíčový identifikátor v architektuře kontinuity hlasového hovoru (VCC) definované ve 3GPP Release 8 a novějších. Funguje jako dočasné, relaci specifické telefonní číslo mobilní stanice ([MSISDN](/mobilnisite/slovnik/msisdn/)) přidělené VCC aplikací v IMS síti, když uživatelské zařízení (UE) iniciuje nebo přijímá hovor s podporou VCC. Toto dočasné číslo se liší od primárního MSISDN uživatele a používá se výhradně po dobu trvání VCC relace k usnadnění procedur přechodu mezi doménami.
