...
Celkové hlasitostní číslo (OLR) je klíčovým parametrem v 3GPP modelu pro plánování telefonního přenosu, definovaném v [ITU-T](/mobilnisite/slovnik/itu-t/) G.107 E-modelu a přijatém 3GPP. Představuje celkový hlasitostní útlum, který zaznamená řečový signál na úplné cestě od konce ke konci od mluvčího u vysílacího terminálu k posluchači u přijímacího terminálu. OLR je vyjádřeno v decibelech (dB) a je odvozeno z algebraického součtu tří hlavních dílčích čísel: vysílacího hlasitostního čísla (SLR), přijímacího hlasitostního čísla (RLR) a členu reprezentujícího efekt maskování vedlejším tónem (STMR - Sidetone Masking Rating a [LSTR](/mobilnisite/slovnik/lstr/) - Listener Sidetone Rating).
