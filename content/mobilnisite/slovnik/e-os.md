...
Koncept E-OS byl vytvořen, aby řešil rostoucí složitost správy více-dodavatelských, více-technologických telekomunikačních sítí. Jak se sítě rozšiřovaly, přímá správa každého jednotlivého síťového prvku z centrálního [OSS](/mobilnisite/slovnik/oss/) se stala nepraktickou kvůli obrovskému objemu dat a rozmanitosti proprietárních rozhraní prvků. Hlavní problém, který řeší, je zprostředkování mezi zařízeními specifickými pro dodavatele a na služby zaměřenými, na dodavateli nezávislými operačními systémy.
