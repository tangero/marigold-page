...
ACK (Acknowledgement) je základní řídicí signál v rámci systému hybridního automatického opakování ([HARQ](/mobilnisite/slovnik/harq/)) 3GPP, který funguje především na fyzické vrstvě. V kontextu downlinkového přenosu, když uživatelské zařízení (UE) úspěšně dekóduje přenosový blok ([TB](/mobilnisite/slovnik/tb/)) přijatý přes fyzický downlinkový sdílený kanál ([PDSCH](/mobilnisite/slovnik/pdsch/)), vyšle ACK na fyzický uplinkový řídicí kanál ([PUCCH](/mobilnisite/slovnik/pucch/)) nebo, v některých konfiguracích, na fyzický uplinkový sdílený kanál ([PUSCH](/mobilnisite/slovnik/pusch/)). Tento signál informuje gNB (v 5G) nebo [eNB](/mobilnisite/slovnik/enb/) (v LTE), že data byla přijata správně, což umožňuje vysílači pokračovat v odesílání dalšího naplánovaného datového paketu. Časový vztah mezi příjmem PDSCH a odpovídajícím přenosem ACK/[NACK](/mobilnisite/slovnik/nack/) je striktně definován časováním HARQ, které se liší v závislosti na numerologii a duplexním režimu ([FDD](/mobilnisite/slovnik/fdd/) nebo TDD).
