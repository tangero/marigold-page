...
Protokol High Speed Protocol (HSP) je standardizovaný protokol v rámci bezpečnostní architektury 3GPP, specifikovaný primárně v TS 33.224. Je navržen tak, aby umožňoval zabezpečený, spolehlivý a vysoce výkonný přenos odposlechnutého komunikačního obsahu a s ním souvisejících informací o odposlechu (Intercept-Related Information, [IRI](/mobilnisite/slovnik/iri/)) ze síťových prvků, jako je Packet Data Network Gateway ([PGW](/mobilnisite/slovnik/pgw/)) nebo User Plane Function ([UPF](/mobilnisite/slovnik/upf/)), k mediační nebo sběrné funkci pro zákonný odposlech (Lawful Interception, [LI](/mobilnisite/slovnik/li/)). Protokol funguje nad [TCP/IP](/mobilnisite/slovnik/tcp-ip/) a je konstruován pro zpracování velkých objemů dat s minimální latencí a vysokou propustností, což je klíčové pro scénáře odposlechu v reálném čase v moderních sítích s vysokou šířkou pásma.
