...
Služba funguje tak, že pro relaci vytvoří kontext MBMS přenosového kanálu. BM-SC zahájí proceduru začátku relace, signalizací přes MBMS-GW k RAN a nakonec k uživatelskému zařízení (UE). RAN rozhodne o způsobu přenosu: buď použije vyhrazený přenosový kanál point-to-point ([PTP](/mobilnisite/slovnik/ptp/)) pro malý počet uživatelů, nebo sdílený přenosový kanál point-to-multipoint ([PTM](/mobilnisite/slovnik/ptm/)) (jako Single Frequency Network – [MBSFN](/mobilnisite/slovnik/mbsfn/) v LTE), když je přítomno mnoho uživatelů, čímž optimalizuje využití zdrojů. Na rádiovém rozhraní jsou MBMS data přenášena na společných fyzických kanálech (např. logický kanál [MTCH](/mobilnisite/slovnik/mtch/) mapovaný na [PMCH](/mobilnisite/slovnik/pmch/) v LTE). UE zájemce o službu monitorují řídicí kanály (MCCH) kvůli informacím o plánování a následně přijímají data na odpovídajícím přenosovém kanálu.
