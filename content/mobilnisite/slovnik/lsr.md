...
Late Stage Reprojection (LSR) je pokročilá technika vykreslování a zpracování obrazu definovaná v rámci 3GPP pro podporu služeb rozšířené reality (XR) přes sítě 5G. Konkrétně řeší problém latence mezi pohybem a zobrazením – zpoždění mezi pohybem uživatele (např. otočením hlavy ve VR) a odpovídající aktualizací obrazu na displeji. Ve scénáři XR vykreslovaného v cloudu/na edge, kde se složitá 3D grafika vykresluje na vzdáleném serveru a streamuje jako video do lehkého headsetu, může tato latence způsobovat dezorientaci, nevolnost a narušovat pocit ponoření. LSR funguje jako finální korekční krok na klientském zařízení (terminálu XR).
