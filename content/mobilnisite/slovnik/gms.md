...
GMS byl vytvořen, aby řešil specifické a přísné požadavky profesionální komunikace a komunikace složek integrovaného záchranného systému, které jsou z velké části závislé na okamžité, spolehlivé a organizované skupinové komunikaci. Tradiční mobilní služby, jako jsou hlasové hovory nebo [SMS](/mobilnisite/slovnik/sms/), byly navrženy pro komunikaci jeden na jednoho a postrádají strukturovanou správu skupin, zpracování priorit a zabezpečení potřebné pro koordinovaný týmový zásah v nouzových situacích. Před jeho standardizací proprietární systémy, jako je Terrestrial Trunked Radio ([TETRA](/mobilnisite/slovnik/tetra/)), nabízely skupinové funkce, ale byly izolované, drahé a neintegrované se širokopásmovými mobilními sítěmi.
