...
HR-SBO (Home Routed with Session Breakout in VPLMN) je architektura roamingu v systému 5G (5GS) definovaná ve specifikacích 3GPP Release 18. Představuje evoluci tradičního modelu Home Routed ([HR](/mobilnisite/slovnik/hr/)), kde je veškerý provoz uživatelské roviny tunelován zpět do domovské veřejné pozemní mobilní sítě ([HPLMN](/mobilnisite/slovnik/hplmn/)). V HR-SBO je protokolová datová jednotka (PDU) Session stále zakotvena u domovské [UPF](/mobilnisite/slovnik/upf/) (User Plane Function), čímž je zachována kontrola domovské sítě a vynucování politik pro primární relaci. Architektura však zavádí klíčové vylepšení: schopnost vytvořit cestu pro lokální vypuštění (local breakout) specifických, autorizovaných datových toků přímo ve visitované PLMN (VPLMN). Toho je dosaženo zřízením sekundárního lokalizovaného bodu kotvení PDU session (PSA) nebo specializované funkce pro odklon provozu v uživatelské rovině VPLMN.

Architektonická implementace se opírá o vylepšení funkce pro správu relací ([SMF](/mobilnisite/slovnik/smf/)) a funkce řízení politik ([PCF](/mobilnisite/slovnik/pcf/)) v jádru 5G. Domovská SMF ([H-SMF](/mobilnisite/slovnik/h-smf/)), která sídlí v HPLMN, zůstává hlavním správcem relace. Spolupracuje s visitovanou SMF (V-SMF) v síti VPLMN při orchestraci lokálního vypuštění. Rozhodnutí o použití SBO je řízeno politikami z domovské PCF, které mohou určovat, že určité požadavky aplikační funkce ([AF](/mobilnisite/slovnik/af/)) nebo názvy datových sítí ([DNN](/mobilnisite/slovnik/dnn/)) jsou lépe obsluhovány lokálně. Například politika může stanovit, že provoz směřující k aplikaci v lokálním edge computingu nebo k uzlu sítě pro doručování obsahu (CDN) ve visitované zemi má použít cestu s lokálním vypuštěním.
