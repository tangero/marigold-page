...
Mezi klíčové komponenty NIT patří identifikátory sítě (jako [PLMN](/mobilnisite/slovnik/plmn/) ID), informace o servisní oblasti a odkazy na další důležité tabulky nebo streamy, jako je Service Description Table ([SDT](/mobilnisite/slovnik/sdt/)) nebo INT (IP/[MAC](/mobilnisite/slovnik/mac/) Notification Table). UE přijímá a parsuje NIT, aby pochopilo, jaké služby MBMS jsou na jeho aktuálním místě dostupné, která síť je poskytuje a jak postupovat k přijetí konkrétní služby. Tento mechanismus je pro UE klíčový pro inicializaci příjmu MBMS, protože snižuje spotřebu energie a signalizační režii ve srovnání s průběžným skenováním nebo unicastovými dotazy.
...
- [SDT – Service Description Table](/mobilnisite/slovnik/sdt/)
