...
Data Collection Application Function (DC-AF) je klíčovou součástí architektury 5G založené na službách (SBA), konkrétně součástí rámce Management Data Analytics ([MDA](/mobilnisite/slovnik/mda/)) definovaného 3GPP. Funguje jako centralizovaný bod pro řízení politik a orchestrátor úloh sběru dat napříč 5G Core Network (5GC) a v některých nasazeních i Radio Access Network (RAN). DC-AF komunikuje s ostatními síťovými funkcemi, jako je Network Data Analytics Function (NWDAF), Network Exposure Function ([NEF](/mobilnisite/slovnik/nef/)) a různými producenty dat (např. [AMF](/mobilnisite/slovnik/amf/), [SMF](/mobilnisite/slovnik/smf/), [UPF](/mobilnisite/slovnik/upf/)), pomocí standardizovaných rozhraní založených na službách (např. Ndcaf_DataCollectionProvisioning, Ndcaf_DataReporting). Jejím hlavním úkolem je převádět vysokou úroveň analytických nebo monitorovacích požadavků – často přijímaných z Operations Support System ([OSS](/mobilnisite/slovnik/oss/)), Business Support System ([BSS](/mobilnisite/slovnik/bss/)) operátora nebo z aplikační funkce ([AF](/mobilnisite/slovnik/af/)) spotřebitele – na konkrétní úlohy sběru dat.
