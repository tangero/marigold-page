...
5G-VN konkrétně řeší tato omezení tím, že poskytuje kompletní rámec, který překlenuje propast mezi síťovými schopnostmi CSP a provozními požadavky podniků. Řeší klíčové problémy včetně: jak nabízet izolované síťové instance se zaručenými výkonnostními charakteristikami, jak poskytnout podnikům možnosti samosprávy, jak zajistit bezpečný multi-tenancy na sdílené infrastruktuře a jak podporovat různé podnikové modely připojení (místní breakout, centralizovaný breakout, hybridní modely). Standardizací těchto aspektů v 3GPP umožňuje 5G-VN interoperabilitu mezi zařízeními různých dodavatelů a vytváří konzistentní servisní model, který může být nasazen globálně, čímž urychluje adopci 5G podniky pro iniciativy digitální transformace.
