...
Primární motivací pro vývoj ALC bylo umožnit komerční vysílací služby, jako je mobilní TV, kde poskytovatelé služeb potřebují garantovat doručení obsahu platícím předplatitelům. Předchozí přístupy vyžadovaly buď nadměrné rádiové prostředky (prostřednictvím opakování), nebo nemohly garantovat doručení v podmínkách na okraji buňky. ALC tyto problémy řeší prostřednictvím kombinace vrstvového kódování a [FEC](/mobilnisite/slovnik/fec/), což umožňuje přijímačům akumulovat data v čase a obnovit je ze ztrát bez nutnosti retransmise od zdroje.
