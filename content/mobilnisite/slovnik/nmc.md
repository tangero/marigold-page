...
Z architektonického hlediska se NMC nachází na vrcholu hierarchie Telecommunications Management Network (TMN), nad Element Management Layer ([EML](/mobilnisite/slovnik/eml/)) a Network Element Layer (NEL). Rozhraní se systémy EMS a někdy přímo s Network Elements (NEs) pomocí standardizovaných (např. Itf-N) nebo proprietárních rozhraní. Mezi klíčové systémy v rámci NMC patří Fault Management ([FM](/mobilnisite/slovnik/fm/)) systémy pro dohled nad alarmy a správu tiketů, Performance Management (PM) systémy pro sběr a analýzu [KPI](/mobilnisite/slovnik/kpi/), Configuration Management ([CM](/mobilnisite/slovnik/cm/)) systémy pro provisioning a správu softwaru a často také funkce Security Management (SM) a Accounting Management ([AM](/mobilnisite/slovnik/am/)). Tyto systémy jsou integrovány tak, aby poskytovaly korelované přehledy napříč doménami.
