...
MOI jsou organizovány ve stromu správy informací ([MIT](/mobilnisite/slovnik/mit/)), což je hierarchický jmenný prostor, kde je každá MOI jednoznačně identifikována svým rozlišujícím jménem ([DN](/mobilnisite/slovnik/dn/)). DN je složeno z relativních rozlišujících jmen ([RDN](/mobilnisite/slovnik/rdn/)) sebe samé a všech jejích nadřazených MOI ve stromu. Tato struktura odráží vztahy obsahové hierarchie; například MOI reprezentující sektor buňky může být potomkem MOI reprezentující buňku, která je zase potomkem MOI reprezentující základnovou stanici. Tato hierarchie umožňuje efektivní, rozsahem omezené řídicí operace. MOI komunikují se systémem správy (správce sítě, [NM](/mobilnisite/slovnik/nm/), nebo správce prvku, [EM](/mobilnisite/slovnik/em/)) prostřednictvím standardizovaných rozhraní, především Itf-N (založeného na [CORBA](/mobilnisite/slovnik/corba/)/[XML](/mobilnisite/slovnik/xml/)) v dřívějších verzích a RESTful 3GPP Management Services (MnS) v 5G.
