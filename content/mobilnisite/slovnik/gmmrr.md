...
GMMRR byl vyvinut k řešení specifických výzev spojených s integrací správy mobility s přepojováním paketů s omezenými prostředky rádiového rozhraní v [GERAN](/mobilnisite/slovnik/geran/). Rané implementace [GPRS](/mobilnisite/slovnik/gprs/) přistupovaly ke správě rádiových prostředků a správě mobility v jádru sítě poněkud nezávisle, což mohlo vést k neefektivitám. Například rádiové prostředky mohly být zbytečně drženy po události mobility nebo mohla být narušena kontinuita relace při změně buňky. Účelem GMMRR je těsně propojit tyto vrstvy pro optimalizovaný výkon.
