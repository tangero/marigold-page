...
Architektura podporující IR je integrována v rámci funkcí kanálového kódování a správy HARQ fyzické vrstvy. Mezi klíčové komponenty patří entita HARQ na straně vysílače i přijímače, která spravuje více paralelních HARQ procesů pro kontinuální tok dat; generátor redundantních verzí (RV), který vybírá konkrétní vzorek systematických a paritních bitů k přenosu; a vyrovnávací paměť pro měkké bity na straně přijímače pro ukládání a kombinaci log-likelihood poměrů. eNodeB/gNB plánuje přenosy a opakované přenosy, zatímco UE provádí dekódování a kombinaci. Konkrétní kódovací schéma, jako jsou Turbo kódy v LTE nebo [LDPC](/mobilnisite/slovnik/ldpc/)/Polar kódy v NR, definuje mateřský kód a pravidla pro generování různých RVs.
