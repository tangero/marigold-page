...
Zavedení NCRT spolu s funkcí [ANR](/mobilnisite/slovnik/anr/) automatizovalo objevování a správu těchto vztahů. Tím byl vyřešen problém škálovatelnosti, což umožnilo sítím samokonfiguraci a samoptimalizaci při nasazování nových buněk. NCRT poskytuje centralizované, dynamické úložiště, které odráží rádiové prostředí v reálném čase, a umožňuje síti přizpůsobit se změnám, jako jsou výpadky buněk nebo nasazení nové infrastruktury. Její účel přesahuje základní konektivitu; je základním prvkem pro funkce samoorganizujících se sítí (SON), které jsou nezbytné pro snížení provozních nákladů ([OPEX](/mobilnisite/slovnik/opex/)) a udržení kvality služeb ve velkých a vyvíjejících se sítích.
