...
Z architektonického hlediska DF typicky komunikuje s několika dalšími síťovými prvky. V kontextu MMS úzce spolupracuje s MMS Relay/Server (MMS-RS), který funguje jako centrální uzel pro provoz MMS. DF přijímá od MMS-RS zprávy, které je třeba doručit příjemci. Následně určuje optimální cestu doručení, což může zahrnovat dotazování na Home Location Register ([HLR](/mobilnisite/slovnik/hlr/)) nebo Home Subscriber Server ([HSS](/mobilnisite/slovnik/hss/)) pro zjištění stavu účastníka a směrovacích informací. Pro doručení na zařízení příjemce DF komunikuje s Gateway [GPRS](/mobilnisite/slovnik/gprs/) Support Node (GGSN) a Serving GPRS Support Node ([SGSN](/mobilnisite/slovnik/sgsn/)) v sítích 2G/3G, nebo s Packet Data Network Gateway ([PGW](/mobilnisite/slovnik/pgw/)) a Serving Gateway ([SGW](/mobilnisite/slovnik/sgw/)) v sítích 4G/5G, aby zajistil datový přenosový kanál pro přenos obsahu.
