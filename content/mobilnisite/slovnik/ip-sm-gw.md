...
Počáteční provizorní řešení jako Circuit-Switched Fallback ([CSFB](/mobilnisite/slovnik/csfb/)) pro SMS nutila zařízení dočasně přepínat na 2G/3G síť pro odesílání/příjem zpráv, což způsobovalo zpoždění a signalizační zátěž. IP-SM-GW poskytla elegantnější, nativní IP řešení. Umožnila operátorům nabízet SMS jako IP aplikaci od prvního dne nasazení LTE, nezávisle na strategii hlasových služeb. To byl klíčový faktor pro raná LTE zařízení a datově orientované služby.
