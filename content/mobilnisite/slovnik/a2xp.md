...
Historicky vychází motivace z širší iniciativy 3GPP na podporu vertikálních a [LAN](/mobilnisite/slovnik/lan/) služeb, včetně pracovní položky '5G for Aviation'. Vytvoření A2XP ve vydání Release-18 bylo hnáno potřebou poskytnout jednotnou řídicí rovinu politik, která rozumí leteckému kontextu. Umožňuje komerční a technickou proveditelnost použití 5G jako primární nebo doplňkové přístupové technologie pro letectví a připravuje cestu pro nové obchodní modely pro operátory mobilních sítí ([MNO](/mobilnisite/slovnik/mno/)), letecké společnosti a úřady řízení letového provozu. Řeší omezení předchozích neintegrovaných přístupů tím, že zajišťuje, aby letecký provoz získal odpovídající síťové zdroje, bezpečnostní zacházení a podporu mobility přímo v rámci standardizované architektury jádra sítě 5G.
