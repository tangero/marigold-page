...
Driftová podsystém základnové stanice (DBSS) je základní architektonický koncept v rámci rádiové přístupové sítě 3GPP UMTS ([UTRAN](/mobilnisite/slovnik/utran/)), definovaný v technické specifikaci 25.423. Funguje v kontextu rozhraní Iur, které propojuje dva řadiče rádiové sítě ([RNC](/mobilnisite/slovnik/rnc/)). V této architektuře, když je uživatelské zařízení (UE) zapojeno do předávání hovoru mezi RNC nebo využívá prostředky od RNC odlišného od svého řídicího RNC, zaujímají zúčastněné RNC specifické role: obsluhující RNC ([SRNC](/mobilnisite/slovnik/srnc/)) a driftový RNC ([DRNC](/mobilnisite/slovnik/drnc/)). DBSS je souhrnný termín pro síťové prvky (především DRNC a jím řízené Node B), které poskytují uživatelskému zařízení rádiové prostředky, ale nejsou primárním bodem kontroly pro připojení tohoto UE k jádru sítě.
