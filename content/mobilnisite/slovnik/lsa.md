...
Historicky bylo diferenciace služeb často dosahováno prostřednictvím oddělené síťové infrastruktury nebo složitých řešení, která byla nákladná a neefektivní. Koncept LSA poskytl standardizovanou, softwarově definovanou metodu pro vytváření logických servisních zón v rámci jedné PLMN. Tím vyřešil problém rigidních servisních hranic a umožnil vytváření 'virtuálních' privátních sítí nebo specializovaných servisních oblastí. Také usnadnil regulatorní soulad pro služby specifické podle polohy a umožnil operátorům konkurovat lokalizovaným bezdrátovým nabídkám, jako jsou Wi-Fi hotspoty, tím, že poskytli bezproblémové, operátorem spravované alternativy s integrovanou mobilitou a účtováním.
