...
Klíčové komponenty popsané v rámci NEST zahrnují Slice Service Type (eSST), Slice Differentiator ([SD](/mobilnisite/slovnik/sd/)) a podrobný seznam profilů řezu. Profil řezu je klíčový prvek, který specifikuje požadavky na podsíťový řez ([NSS](/mobilnisite/slovnik/nss/)), jež detailně popisují konkrétní chování a schopnosti potřebné od částí RAN a Core Network. To zahrnuje výběr síťových funkcí ([NF](/mobilnisite/slovnik/nf/)), jejich propojení prostřednictvím rozhraní založených na službách ([SBI](/mobilnisite/slovnik/sbi/)) a specifické konfigurace pro funkce jako je politika výběru síťového řezu ([NSSP](/mobilnisite/slovnik/nssp/)). Předloha také zahrnuje politiky správy životního cyklu, deskriptory monitorování pro zajištění řezu a požadavky na zabezpečení a izolaci.
