...
Algoritmus FFT byl přijat ve standardech 3GPP, aby umožnil praktickou implementaci OFDM, přenosového schématu zvoleného pro LTE (Rel-8) a NR díky jeho vysoké spektrální účinnosti a odolnosti v prostředí s vícecestným šířením. Základním problémem, který OFDM řeší, je frekvenčně selektivní útlum ve širokopásmových kanálech, ale vyžaduje výpočetně proveditelnou metodu pro generování a dekódování velkého počtu těsně rozmístěných ortogonálních podnosných.
