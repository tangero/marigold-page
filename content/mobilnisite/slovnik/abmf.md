...
ABMF byla vytvořena, aby řešila základní potřebu správy zůstatků v reálném čase a spolehlivým způsobem v telekomunikačních sítích, zejména s nástupem předplacených služeb. Před standardizací online účtování byly předplacené systémy často proprietární a izolované, což ztěžovalo nabídku konvergentních služeb (např. hlas, data a zasílání zpráv na jeden zůstatek) nebo integraci s moderními službami založenými na IP. ABMF jako součást architektury OCS 3GPP, představené ve vydání 5 a upravené ve vydání 8, poskytuje standardizovaný, robustní mechanismus pro konzistentní správu zůstatků na účtech účastníků napříč všemi službami.
