...
Access Preamble Acquisition Indicator Channel (AP-AICH) je vyhrazený downlinkový fyzický kanál specifikovaný pro režim [UTRA](/mobilnisite/slovnik/utra/) [FDD](/mobilnisite/slovnik/fdd/) v UMTS. Funguje v rámci fyzické vrstvy [WCDMA](/mobilnisite/slovnik/wcdma/) definované ve specifikacích 3GPP Release 4 a novějších. AP-AICH vysílá Node B (základnová stanice) a je neodmyslitelně spojen s procedurou na Physical Random Access Channel ([PRACH](/mobilnisite/slovnik/prach/)). Jeho primární funkcí je poskytnout rychlý a spolehlivý mechanismus potvrzení pro přístupové preambule odesílané uživatelským zařízením (UE), které se pokouší navázat počáteční spojení nebo požádat o zdroje na uplinku.
