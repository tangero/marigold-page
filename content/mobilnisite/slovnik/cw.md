...
Účelem specifikace a použití signálů Continuous Wave ve standardech 3GPP je stanovit základní, jednoznačnou referenci pro testování výkonnosti rádiových frekvencí. Před nástupem složitých digitálních modulačních schémat používaných v buněčné komunikaci byl CW primárním signálem používaným v rádiovém inženýrství. Jeho začlenění do specifikací 3GPP poskytuje nadčasovou a technologicky neutrální metodu pro ověření analogového výkonu RF komponent, která je nezávislá na konkrétním rádiovém rozhraní (např. WCDMA, [OFDMA](/mobilnisite/slovnik/ofdma/)). To umožňuje izolovat hardwarové nedostatky od problémů s protokolem nebo digitálním zpracováním signálu.
