...
LCCF byla vytvořena za účelem poskytnutí standardizovaného, bezpečného a řízeného rozhraní mezi externími poskytovateli služeb a interními schopnostmi určování polohy mobilní sítě. Před její standardizací proprietární rozhraní ztěžovala poskytovatelům aplikací třetích stran přístup k polohovým informacím, což brzdilo inovace v polohových službách ([LBS](/mobilnisite/slovnik/lbs/)). LCCF tento problém řeší definicí jasného [API](/mobilnisite/slovnik/api/) (rozhraní Le) a řídicí funkce pro správu přístupu.
