...
Accounting Answer (ACA) je klíčový aplikační příkaz Diameter v referenčních bodech Ro a Gy podle 3GPP, definovaný v rámci Diameter Credit-Control Application ([DCCA](/mobilnisite/slovnik/dcca/)) ([RFC](/mobilnisite/slovnik/rfc/) 4006). Funguje jako konečná odpověď od Online Charging Systemu ([OCS](/mobilnisite/slovnik/ocs/)) na předchozí Accounting Request ([ACR](/mobilnisite/slovnik/acr/)) odeslaný síťovou funkcí fungující jako Diameter klient, například Policy and Charging Enforcement Function ([PCEF](/mobilnisite/slovnik/pcef/)) v [P-GW](/mobilnisite/slovnik/p-gw/) nebo Application Function ([AF](/mobilnisite/slovnik/af/)). Zpráva ACA nese rozhodnutí OCS ohledně požadované kvóty služebních jednotek (např. objemu dat, časového trvání nebo peněžního kreditu) pro konkrétní uživatelskou služební relaci.
