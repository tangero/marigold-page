...
Access Unit byl vytvořen, aby vyřešil základní problém vzájemného propojení sítí mezi novými digitálními sítěmi založenými na ISDN (včetně raných digitálních celulárních sítí jako GSM) a rozsáhlou instalovanou základnou ne-ISDN datových koncových zařízení, zejména těch používajících sadu protokolů X.25. Před nástupem ISDN a mobilních digitálních sítí datová komunikace terminálů často závisela na vyhrazených pronajatých linkách nebo vytáčených modemech používajících analogové telefonní sítě (PSTN) s protokolem X.25. Omezení těchto přístupů zahrnovala nízké rychlosti, šum na analogových linkách a neefektivní využití infrastruktury.
