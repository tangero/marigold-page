...
Z architektonického hlediska slouží CBR jako vstup pro funkce správy rádiových prostředků (RRM) na vyšších vrstvách. Naměřené hodnoty CBR jsou hlášeny síti nebo použity lokálně pro autonomní rozhodování. Mezi klíčové zapojené komponenty patří obvody pro měření na fyzické vrstvě pro detekci výkonu signálu, logika vrstvy řízení přístupu k médiu ([MAC](/mobilnisite/slovnik/mac/)) pro porovnání s prahem a výpočet poměru a protokoly řízení rádiových prostředků ([RRC](/mobilnisite/slovnik/rrc/)) pro konfiguraci a hlášení. V síti jsou tyto hlášení agregovány a analyzovány inteligencí rádiové přístupové sítě (RAN) za účelem vyhodnocení zahlcení, predikce rušení a úpravy přenosových parametrů.
