...
Protokol 5G Mobility Management (5GMM) je protokol ne-přístupové vrstvy ([NAS](/mobilnisite/slovnik/nas/)) definovaný ve specifikacích 3GPP, především v TS 24.501. Funguje mezi uživatelským zařízením (UE) a funkcí pro správu přístupu a mobility ([AMF](/mobilnisite/slovnik/amf/)) v 5G Core síti (5GC). 5GMM je zodpovědný za správu mobility a registračního kontextu UE, zajišťuje, aby mohlo bezpečně a efektivně přistupovat k síťovým službám. Vytváří a udržuje signalizační spojení NAS, které je klíčové pro veškerou řídicí komunikaci mezi UE a jádrem sítě, nezávisle na podkladové technologii rádiového přístupu (např. NG-RAN, ne-3GPP přístup).
