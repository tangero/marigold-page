...
BSSMAP byl vytvořen k řešení základní potřeby standardizované signalizace mezi subsystémem základnových stanic ([BSS](/mobilnisite/slovnik/bss/)) a přepínacím subsystémem sítě (NSS) v sítích GSM. Před standardizací GSM používaly celulární systémy často proprietární rozhraní mezi rádiovým zařízením a přepínacími systémy, což omezovalo interoperabilitu mezi zařízeními od různých výrobců a zvyšovalo náklady na nasazení. BSSMAP poskytl standardizovaný protokol, který umožnil interoperabilitu mezi více výrobci a zároveň podporoval složitou koordinaci potřebnou pro správu mobility a přidělování rádiových prostředků v celulárních sítích.
