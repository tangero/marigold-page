...
Řešil potřebu standardizovaného architektonického modelu při začleňování rádiových přístupových technologií nepocházejících od 3GPP. Před takovými definicemi byla integrace proprietární a omezená. Definování FP a jeho rozhraní (např. rozhraní 'A' mezi komponentami FP, rozhraní vzduch k [PP](/mobilnisite/slovnik/pp/) a mezifunkční rozhraní k páteřní síti) vytvořilo vzor pro konzistentní implementaci. To podporovalo scénáře, jako je použití DECT jako rádiové části místní smyčky (RLL) k poskytování telefonní služby, kde se FP připojuje k tradiční telefonní síti, nebo později k jádru IMS 3GPP pro služby VoIP.
