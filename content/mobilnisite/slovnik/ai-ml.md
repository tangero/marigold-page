...
Klíčové komponenty zahrnují systém pro správu pipeline AI/ML, který zvládá kompletní životní cyklus ML modelů od tréninku přes nasazení až po monitorování. [NWDAF](/mobilnisite/slovnik/nwdaf/) (Network Data Analytics Function) v 5G core síti slouží jako centralizovaný analytický engine, který může hostovat ML modely pro síťovou a servisní analytiku. Architektura RIC podporuje xApps a rApps implementující ML algoritmy pro optimalizaci RAN, se standardizovanými rozhraními (A1, E2) pro výměnu dat a řízení. Framework také specifikuje mechanismy sběru dat včetně standardizovaných datových sad, frekvencí sběru a datových formátů, aby byla zajištěna interoperabilita mezi řešeními AI/ML od různých dodavatelů.
