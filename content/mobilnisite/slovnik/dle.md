...
Cílová místní ústředna (Destination Local Exchange – DLE) je funkční entita v okruhově spínané ([CS](/mobilnisite/slovnik/cs/)) doméně sítě GSM nebo UMTS, konkrétně součást architektury veřejné telefonní sítě ([PSTN](/mobilnisite/slovnik/pstn/)) nebo sítě [ISDN](/mobilnisite/slovnik/isdn/), jak je definováno standardy 3GPP. Představuje místní telefonní ústřednu obsluhující koncového účastníka. Při směrování mobilního odchozího nebo příchozího hovoru sítí se bránová [MSC](/mobilnisite/slovnik/msc/) ([GMSC](/mobilnisite/slovnik/gmsc/)) dotazuje domovského registračního centra ([HLR](/mobilnisite/slovnik/hlr/)) pro získání směrovacích informací. Tyto informace často odkazují na navštívenou MSC ([VMSC](/mobilnisite/slovnik/vmsc/)), kde je účastník aktuálně registrován. Pro hovory určené pevným účastníkům nebo v určitých směrovacích scénářích je však hovor předán právě DLE, která je zodpovědná za konečné fyzické připojení k účastníkově koncové stanici.
