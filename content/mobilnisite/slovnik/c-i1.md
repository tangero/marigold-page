...
Hodnota C/I1 je kritickým vstupem pro několik algoritmů správy rádiových prostředí ([RRM](/mobilnisite/slovnik/rrm/)) definovaných ve specifikacích 3GPP. Přímo ovlivňuje výběr modulačního a kódového schématu ([MCS](/mobilnisite/slovnik/mcs/)) prostřednictvím procesů adaptace spojení. Vysoká hodnota C/I1 indikuje čistý signál, což umožňuje použití modulací vyššího řádu, jako je [8-PSK](/mobilnisite/slovnik/8-psk/) pro EDGE, nebo méně robustního kódování pro maximalizaci datového propustnosti. Naopak nízká hodnota C/I1 spouští přechod na robustnější schémata s nižší propustností, jako je GMSK. Dále se měření C/I1 používají v algoritmech řízení výkonu k minimalizaci vysílacího výkonu při zachování kvality spoje, čímž se snižuje celkové rušení v síti a zlepšuje se výdrž baterie. Přispívají také k rozhodování o přechodech mezi buňkami, což síti pomáše nasměrovat spojení k buňce s příznivějším rušivým prostředím.
