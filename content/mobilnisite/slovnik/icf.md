...
Historický kontext vychází z práce 3GPP na bezpečnosti MTC počínaje Release 9 a vyvíjející se v pozdějších releasech. Rané studie MTC identifikovaly potřebu vylepšených bezpečnostních opatření pro zařízení, která nemusí mít UICC nebo mohou používat odlehčené autentizační metody. Omezení předchozích přístupů spočívalo v absenci standardizovaného, síťově asistovaného mechanismu pro přechod zařízení od jednoduchých, továrních výchozích přihlašovacích údajů k robustní, služebně specifické sadě přihlašovacích údajů plně automatizovaným a bezpečným způsobem. ICF tento mechanismus poskytuje.
