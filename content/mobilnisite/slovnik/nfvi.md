...
V softwarovém srdci NFVI leží virtualizační vrstva, nejčastěji hypervizor (pro nasazení založená na VMs) nebo kontejnerový runtime (pro nasazení založená na kontejnerech). Tato vrstva je zodpovědná za abstrakci fyzických prostředků, jejich rozdělení a prezentaci jako virtuálních prostředků VNFs. Spravuje životní cyklus těchto virtuálních prostředků, zajišťuje izolaci, zabezpečení a výkon pro každou [VNF](/mobilnisite/slovnik/vnf/). Nad ní poskytuje správce virtuální infrastruktury ([VIM](/mobilnisite/slovnik/vim/)), jako je OpenStack nebo Kubernetes, orchestraci a řídicí rovinu pro tyto virtuální prostředky. VIM řeší úkoly jako inventář prostředků, jejich alokaci, umístění a monitorování a komunikuje s vyššími systémy pro správu a orchestraci, jako je [NFVO](/mobilnisite/slovnik/nfvo/).
