...
Před standardizovanou E2EE postrádaly služby obohacené komunikace ([RCS](/mobilnisite/slovnik/rcs/)) a služby založené na IMS poskytované operátory tuto úroveň ochrany soukromí obsahu. Omezení spočívalo v tom, že zabezpečení končilo na síťové bráně. Cílem standardizace bylo poskytnout interoperabilní řešení E2EE na úrovni operátora, které by mohlo být integrováno do IMS a dalších servisních rámců 3GPP, což by operátorům umožnilo nabízet konkurenceschopné a bezpečné služby. Řešila tak problém udržení důvěry uživatelů v éře, kdy síťový operátor již není jedinou – nebo nejdůvěryhodnější – stranou v komunikačním řetězci.
