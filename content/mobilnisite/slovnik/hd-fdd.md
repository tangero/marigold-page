...
Na architektonické úrovni má HD-FDD UE zjednodušené RF přední části ve srovnání s plně duplexním FDD (FD-FDD) UE. FD-FDD UE vyžaduje vysoce výkonný duplexer – filtr, který izoluje silný výstupní vysílací signál od citlivého příchozího přijímaného signálu, protože oba jsou aktivní současně na sousedních frekvencích. HD-FDD UE může používat jednodušší přepínač nebo méně výkonný duplexer, protože vysílací a přijímací cesty nejsou nikdy aktivní ve stejný okamžik. Toto snížení nákladů a složitosti RF komponent je hlavní výhodou.
