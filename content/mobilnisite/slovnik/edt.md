...
Historický kontext jeho významu v 3GPP vychází ze zavedení LTE v neregulovaném spektru ([LAA](/mobilnisite/slovnik/laa/)) v Release 13 a [NR-U](/mobilnisite/slovnik/nr-u/) v Release 16. Předtím byla dominantní technologií v pásmech jako 5 GHz Wi-Fi, která používala CSMA/CA s vlastními definicemi EDT. Vstup 3GPP do neregulovaného spektra si vyžádal robustní mechanismus Poslechu před vysíláním (LBT), aby splnil regulatorní požadavky (např. ETSI EN 301 893) a zajistil pokojnou koexistenci s usedlými systémy, jako je Wi-Fi. EDT je centrálním parametrem tohoto mechanismu LBT.
