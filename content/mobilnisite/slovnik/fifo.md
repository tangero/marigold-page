...
V systémech 3GPP byla standardizována, aby poskytla jasné, interoperabilní základní chování pro protokolové entity, jako je vrstva [RLC](/mobilnisite/slovnik/rlc/). Tím se řeší problém, jak spolehlivě rekonstruovat datový proud z potenciálně nesprávně seřazených nebo opakovaně přenášených paketů přes nespolehlivý rádiový spoj. Disciplína FIFO na přijímací straně v kombinaci s pořadovými čísly umožňuje vrstvě RLC doručit dokonalý sekvenční proud do vrstvy PDCP, čímž skrývá složitosti rozhraní rádiového přístupu před protokoly vyšších vrstev.
