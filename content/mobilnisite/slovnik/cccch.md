...
CCCCH byl vytvořen k řešení specifických požadavků paketově orientovaných datových služeb v sítích GPRS/EDGE, které se výrazně lišily od tradičních služeb přepojování okruhů pro hlas. Před GPRS používaly sítě GSM pro veškerou signalizaci společného řízení kanál CCCH, ale tento přístup nebyl optimalizovaný pro přerušovanou, "bursty" povahu paketového datového provozu. Stávající mechanismy CCCH byly navrženy primárně pro zřizování hlasových hovorů a neefektivně zvládaly časté, malé datové přenosy charakteristické pro rané mobilní datové aplikace.
