...
Extended Dual slot Access Burst (EDAB) je fyzická struktura burstu definovaná v GSM specifikacích pro náhodný přístupový kanál ([RACH](/mobilnisite/slovnik/rach/)). Představuje vylepšení oproti standardnímu přístupovému burstu ([AB](/mobilnisite/slovnik/ab/)), který zabírá jediný časový slot. EDAB, jak již název napovídá, rozšiřuje přenos na dva po sobě následující časové sloty v rámci [TDMA](/mobilnisite/slovnik/tdma/) rámce. Toho dosáhne mobilní stanice ([MS](/mobilnisite/slovnik/ms/)) vysíláním speciálně formátovaného burstu, který pokrývá tyto dva sloty. Struktura burstu zahrnuje rozšířenou tréninkovou sekvenci a ochranné periody přizpůsobené pro dvouslotovou délku, jak je podrobně popsáno ve specifikacích jako 45.001 a 45.003.
