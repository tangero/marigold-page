...
HLG byl vyvinut, aby řešil výzvu zavedení videa s vysokým dynamickým rozsahem (HDR) do vysílacích a streamovacích ekosystémů bez narušení stávající instalované základny displejů se standardním dynamickým rozsahem (SDR). Předchozí HDR přístupy, primárně založené na PQ, vyžadovaly statická nebo dynamická metadata k popisu charakteristik masteringového displeje pro správné tonální mapování. To přidávalo složitost živé produkci a představovalo problém kompatibility: SDR displej přijímající PQ signál by bez sofistikovaného, zařízení-specifického tonálního mapování zobrazoval silně vybledlý nebo tmavý obraz. HLG to řeší použitím převodní funkce, která je vztažena k displeji, nikoli ke scéně.
