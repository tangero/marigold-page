...
Over-The-Air Rekeying (OTAR) je standardizovaný bezpečnostní protokol definovaný ve specifikacích 3GPP pro systémy Project 25 (P25) Fáze [II](/mobilnisite/slovnik/ii/). P25 je soubor standardů pro digitální rádiovou komunikaci hojně využívaný složkami veřejné bezpečnosti a federálními i státními agenturami v Severní Americe a jinde. OTAR konkrétně řídí proces vzdálené aktualizace šifrovacích klíčů uložených v účastnických jednotkách (radiostanicích) P25. Jeho primární funkcí je nahradit stávající klíče pro šifrování provozu (TEK) nebo klíče pro šifrování klíčů ([KEK](/mobilnisite/slovnik/kek/)) novými, což je proces klíčový pro pravidelné obměny klíčů a nouzové odvolání klíčů.
