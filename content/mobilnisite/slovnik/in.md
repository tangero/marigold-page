...
V kontextu 3GPP byly principy IN klíčové pro přenesení inteligentních služeb do GSM a následných mobilních sítí. Potřeba pokročilých, operátorem řízených služeb, které fungují bez problémů v domovských sítích a během roamingu, byla klíčovým hnacím motorem. Standard [CAMEL](/mobilnisite/slovnik/camel/), který je implementací IN pro mobilní síť, byl vyvinut pro poskytování služeb jako předplacený roaming, který byl komerčně klíčový, ale nemožný s tradiční logikou na přepojovačích. IN tedy poskytlo architektonický návrh pro programovatelnou, službami orientovanou základní síť, která podporuje moderní telekomunikace.
