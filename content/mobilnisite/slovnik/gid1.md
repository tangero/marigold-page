...
V síťové architektuře GID1 používají různé síťové funkce, primárně v jádru sítě. Například profil účastníka v [HLR](/mobilnisite/slovnik/hlr/) (Home Location Register) nebo [HSS](/mobilnisite/slovnik/hss/) (Home Subscriber Server) může být propojen s hodnotou GID1. Když se UE registruje, MSC (Mobile Switching Center) nebo SGSN (Serving GPRS Support Node) může předat GID1 do HLR/HSS. HLR/HSS pak může tento skupinový identifikátor použít jako klíč k aplikaci konkrétní servisní logiky, tarifních plánů nebo přístupových omezení definovaných pro danou skupinu. Slouží jako nástroj kategorizace účastníků v rámci operatorových Business a Operational Support Systems (BSS/OSS).
