...
V kontextu 5G [SDAP](/mobilnisite/slovnik/sdap/) byl mechanismus EPDU klíčový pro návrh flexibilní uživatelské roviny, která podporuje rozmanité služby s různými požadavky na QoS. SDAP potřeboval mapovat IP toky na rádiové přenosy na základě pravidel QoS, ale zacházení s IP pakety jako s neprůhlednými EPDU znamenalo, že návrh vrstvy SDAP mohl být zjednodušen a připraven na budoucnost. Mohla by zpracovávat jakýkoli formát [PDU](/mobilnisite/slovnik/pdu/) vyšší vrstvy (IPv4, IPv6, Ethernet nebo budoucí protokoly) beze změny, pokud byl prezentován jako EPDU. To podporuje vizi 5G jako službami řízené architektury schopné podporovat širokou škálu vertikálních odvětví.
