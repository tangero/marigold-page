...
EID pracuje na různých vrstvách protokolu v závislosti na testovacím případu. Například může poškodit bity v transportních blocích fyzické vrstvy, zavést chyby do hlaviček [MAC](/mobilnisite/slovnik/mac/) vrstvy, simulovat ztráty [RLC](/mobilnisite/slovnik/rlc/) protokolových datových jednotek ([PDU](/mobilnisite/slovnik/pdu/)) nebo poškodit [PDCP](/mobilnisite/slovnik/pdcp/) či [RRC](/mobilnisite/slovnik/rrc/) zprávy. Chyby jsou vkládány řízeným a opakovatelným způsobem podle specifikací 3GPP testů (jako jsou ty v řadě 36.5xx pro LTE [RF](/mobilnisite/slovnik/rf/) konformní testy). Testovací systém nakonfiguruje EID parametry definující vzor chyby, míru vkládání a cílovou vrstvu nebo kanál. Reakce UE jsou následně monitorovány a hodnoceny vůči očekávanému chování definovanému v protokolových standardech.
