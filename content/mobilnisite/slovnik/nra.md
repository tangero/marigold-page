...
Non-Aggregated [RUCI](/mobilnisite/slovnik/ruci/) Report Answer (NRA) je protokolová zpráva definovaná v rámci mechanismu hlášení RAN and User Plane Congestion Information (RUCI) od 3GPP, specifikovaná v architektuře Policy and Charging Control ([PCC](/mobilnisite/slovnik/pcc/)). Je přenášena z uzlu rádiové přístupové sítě (RAN), jako je [eNB](/mobilnisite/slovnik/enb/) nebo gNB, do funkce jádra sítě, typicky Traffic Detection Function ([TDF](/mobilnisite/slovnik/tdf/)) nebo Policy and Charging Rules Function ([PCRF](/mobilnisite/slovnik/pcrf/)) prostřednictvím Policy and Charging Enforcement Function ([PCEF](/mobilnisite/slovnik/pcef/)). Zpráva je přímou odpovědí na žádost o informace o kongesci a obsahuje podrobná data na úrovni jednotlivých událostí nebo toků, na rozdíl od agregovaných statistik.
