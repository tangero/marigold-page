...
Historicky, před rozšířeným přijetím ACU, vyžadovala implementace víceanténních systémů samostatné transceivery pro každý anténní prvek, což výrazně zvyšovalo náklady, velikost a spotřebu energie základnové stanice. To činilo pokročilé anténní technologie ekonomicky nepraktické pro mnohá nasazení. ACU tento problém řeší tím, že umožňuje více anténním prvkům sdílet společné transceiverové zdroje prostřednictvím analogového kombinování signálu, což dramaticky snižuje hardwarovou režii víceanténních implementací. To bylo obzvláště důležité, jak se standardy 3GPP vyvíjely a začaly zahrnovat podporu pro diverzitu vysílání, diverzitu příjmu a nakonec technologie MIMO počínaje HSDPA v Release 5.
