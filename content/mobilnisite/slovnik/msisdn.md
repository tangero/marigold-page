...
Mobile Station International Subscriber Directory Number (MSISDN) je primární, mezinárodně standardizovaný identifikátor mobilního účastníka ve veřejné telefonní síti ([PSTN](/mobilnisite/slovnik/pstn/)) a v digitální síti s integrovanými službami ([ISDN](/mobilnisite/slovnik/isdn/)). Řídí se číslovacím plánem [ITU-T](/mobilnisite/slovnik/itu-t/) E.164 a skládá se z kódu země ([CC](/mobilnisite/slovnik/cc/)), z národního směrovacího čísla ([NDC](/mobilnisite/slovnik/ndc/)), které často identifikuje operátora mobilní sítě, a z čísla účastníka ([SN](/mobilnisite/slovnik/sn/)). Toto číslo není uloženo na samotné [SIM](/mobilnisite/slovnik/sim/) kartě, ale je klíčovým datovým prvkem v profilu účastníka v registru domácích účastníků ([HLR](/mobilnisite/slovnik/hlr/)) v sítích GSM/UMTS nebo na serveru domácích účastníků (HSS) v sítích LTE/5G. MSISDN je odděleno od hardwarové identity zařízení (IMEI) a identity SIM karty (IMSI), což umožňuje účastníkovi měnit zařízení při zachování čísla a umožňuje přenosnost čísel mezi operátory.
