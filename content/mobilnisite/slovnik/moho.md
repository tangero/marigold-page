...
Technický proces zahrnuje fyzickou a protokolovou vrstvu UE. Vrstva 1 (fyzická vrstva) UE měří výkon přijímaného referenčního signálu ([RSRP](/mobilnisite/slovnik/rsrp/)), kvalitu přijímaného referenčního signálu ([RSRQ](/mobilnisite/slovnik/rsrq/)) v LTE/5G nebo výkon přijímaného signálového kódu ([RSCP](/mobilnisite/slovnik/rscp/)) v UMTS. Tato měření zpracovává vrstva řízení rádiových prostředků ([RRC](/mobilnisite/slovnik/rrc/)) UE. Na základě nastavených prahových hodnot a parametrů hystereze přijatých od sítě se entita RRC v UE rozhodne, zda má být odesláno měřicí hlášení spouštěné událostí. Pro MOHO může toto hlášení obsahovat doporučení pro konkrétní cílovou buňku. Po přijetí tohoto hlášení učiní RAN uzel sítě (např. eNodeB, gNB) konečné rozhodnutí, přičemž zváží další faktory, jako je zatížení sítě a řízení přístupu, než provede fáze přípravy a provedení předání s cílovou buňkou.
