...
LDN existuje k řešení základního problému jednoznačné a konzistentní identifikace mnoha konfigurovatelných a monitorovatelných entit v komplexní telekomunikační síti. Rané systémy správy často používaly proprietární nebo ploché (flat) systémy pojmenování, což vedlo k integračním problémům, nejednoznačnosti a problémům se škálovatelností s růstem sítí. LDN jako součást standardizovaných principů [TMN](/mobilnisite/slovnik/tmn/) poskytuje jednotný hierarchický pojmenovávací model, který odráží skutečnou strukturu sítě a zařízení.
