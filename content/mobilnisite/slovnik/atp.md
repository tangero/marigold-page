...
Klíčové komponenty zapojené do implementace ATP zahrnují měřicí funkce v přístupových uzlech (eNodeB, gNB nebo přístupové brány), funkce řízení politiky a účtování (PCRF/PCEF) a aplikační funkce, které informace ATP spotřebovávají. Přístupová síť průběžně monitoruje přenosové charakteristiky a aktualizuje hodnoty ATP, které jsou následně šířeny k rozhodovacím entitám. Tyto entity používají ATP k informovanému rozhodování o řízení přijímání služeb, přidělování prostředků, směrování provozu a adaptaci kvality, čímž zajišťují optimální poskytování služeb vzhledem k aktuálním přenosovým podmínkám.
