...
Historicky měly rané mobilní sítě omezené možnosti propojení mezi sítěmi, ale s růstem globálního roamingu a služeb více operátorů zavedla 3GPP specifikace NNI od verze R99. Tato rozhraní řeší omezení, jako jsou nekompatibilní signalizační protokoly, odlišné účtovací mechanismy a bezpečnostní mezery mezi sítěmi. Poskytují společný rámec pro sítě k výměně uživatelských dat, správě relací, zpracování fakturace a vynucování bezpečnostních politik přes hranice.
