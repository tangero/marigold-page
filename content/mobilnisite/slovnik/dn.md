...
Distinguished Name (DN) je klíčový koncept v architektuře Telekomunikační správní sítě (TMN) a správy sítě ([NM](/mobilnisite/slovnik/nm/)) podle 3GPP, silně založený na modelu adresáře [OSI](/mobilnisite/slovnik/osi/) X.500. Poskytuje globálně jednoznačnou hierarchickou cestu k identifikaci jakékoli instance spravovaného objektu ve stromu správních informací. DN je konstruován jako sekvence Relativních Distinguished Names (RDN), kde každý RDN je pár atribut-hodnota (např. `SubNetwork=PLMN-PLMN`, `ManagedElement=ME123`). Tato sekvence začíná od kořene správního stromu a postupuje dolů ke konkrétnímu objektu, čímž vytváří jednoznačnou adresu, například `SubNetwork=PLMN-PLMN/ManagedElement=ME123/Equipment=1`. Tato struktura odráží fyzickou nebo logickou hierarchii sítě, jako je Network, SubNetwork, Managed Element a Equipment.
