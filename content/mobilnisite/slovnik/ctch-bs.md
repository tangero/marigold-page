...
Motivace pramenila z rostoucí poptávky po vysílacích službách, jako jsou zpravodajské výstrahy, předpověď počasí, dopravní informace a následně i multimediální obsah. CTCH-BS umožňuje síti přenášet takové informace jednou přes společný kanál, což umožňuje všem zainteresovaným uživatelským zařízením (UE) v buňce přijmout je současně. Tím se ve srovnání s individuálními přenosy typu point-to-point šetří rádiové prostředky i šířka pásma jádra sítě. Poskytuje také základ pro pokročilejší vysílací/skupinové služby, jako je MBMS, které byly zavedeny v pozdějších vydáních 3GPP.

Historicky měl GSM službu vysílání v buňce (CBS) využívající kanál Cell Broadcast Channel (CBCH), ale UMTS vyžadovalo novou architekturu integrovanou s jeho přenosovými kanály založenými na WCDMA a protokoly vrstvy MAC. Definice CTCH-BS v TS 25.324 tuto integraci poskytla, což zajistilo kompatibilitu s rámcem QoS UMTS, mechanismy řízení výkonu (pro společné kanály) a plánovacími algoritmy. Odstranila omezení dřívějších přístupů tím, že nabídla flexibilní strukturu sady přenosových bloků, která se mohla přizpůsobit různým datovým rychlostem a požadavkům služeb, a podpořila tak vývoj od jednoduchých textových vysílání k bohatšímu multimediálnímu obsahu.
