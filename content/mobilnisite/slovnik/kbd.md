...
Dále, v kontextu testování audio kodeků (jeho primární specifikace v TS 26.403), slouží KBD jako kritická komponenta pro objektivní měření percepční kvality. Používá se v percepčním hodnocení kvality řeči (PESQ) a dalších algoritmech k okenování audio signálů před transformací, což zajišťuje reprodukovatelnost testů a dobrou korelaci se subjektivními poslechovými testy u lidí. Tato standardizace zajišťuje konzistentnost hodnocení kvality hlasu v celém odvětví, což podporuje zlepšování v návrhu kodeků a plánování sítí pro hlasové služby.
