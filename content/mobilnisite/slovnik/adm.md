...
ADM (Administrative Access Condition) je základní bezpečnostní koncept ve specifikacích 3GPP pro aplikace Universal Integrated Circuit Card (UICC) a Universal Subscriber Identity Module ([USIM](/mobilnisite/slovnik/usim/)). Funguje jako příznak nebo podmínka řízení přístupu přidružená ke konkrétním elementárním souborům (EFs) uloženým na čipové kartě. K [EF](/mobilnisite/slovnik/ef/) označenému ADM může přistupovat (pro čtení, aktualizaci nebo mazání) pouze entita disponující správným ADM klíčem nebo přihlašovacími údaji, které výhradně vlastní administrativní autorita – obvykle mobilní síťový operátor ([MNO](/mobilnisite/slovnik/mno/)) nebo poskytovatel služeb, který UICC vytvořil a personalizoval.
