...
Klíčové komponenty zapojené do implementace ABBA zahrnují bezpečnostní modul UE ([USIM](/mobilnisite/slovnik/usim/)), funkci bezpečnostní kotvy obsluhující sítě ([SEAF](/mobilnisite/slovnik/seaf/) v 5GC, která komunikuje s [AUSF](/mobilnisite/slovnik/ausf/) - Authentication Server Function) a autentizační přihlašovací údaje domovské sítě (uložené v [UDM](/mobilnisite/slovnik/udm/)/ARPF - Unified Data Management / Authentication Credential Repository and Processing Function). Parametr ABBA sám o sobě není samostatnou zprávou, ale je vložen do jiných bezpečnostních kontejnerů, jako je zpráva Authentication Response odesílaná z UE do sítě. Jeho hodnota je vypočítána pomocí vstupů, které zahrnují jméno obsluhující sítě (SNN), a explicitně indikuje typ jádra sítě (5GC nebo EPC), ke kterému se UE registruje.
