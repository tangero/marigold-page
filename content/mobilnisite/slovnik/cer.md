...
Capabilities Exchange Request (CER) je základní příkaz v základním protokolu Diameter ([RFC](/mobilnisite/slovnik/rfc/) 6733), který je rozsáhle používán v architekturách 3GPP pro autentizaci, autorizaci a účtování ([AAA](/mobilnisite/slovnik/aaa/)). Jako protokol typu peer-to-peer vyžaduje Diameter, aby si uzly před zahájením komunikace specifické pro danou aplikaci stanovily vzájemné schopnosti. Zpráva CER je úvodní požadavek odeslaný během fáze výměny schopností, která probíhá poté, co je mezi dvěma uzly Diameter (např. mezi Diameter klientem, jako je Policy and Charging Rules Function - [PCRF](/mobilnisite/slovnik/pcrf/), a Diameter serverem, jako je Home Subscriber Server - [HSS](/mobilnisite/slovnik/hss/)) navázáno transportní spojení (např. TCP nebo [SCTP](/mobilnisite/slovnik/sctp/)). CER obsahuje sadu atribut-hodnota párů ([AVP](/mobilnisite/slovnik/avp/)), které inzerují identitu odesílatele, podporované Diameter aplikace, bezpečnostní mechanismy a schopnosti specifické pro výrobce.
