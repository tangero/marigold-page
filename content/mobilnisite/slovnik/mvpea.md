...
MVPEA byla vytvořena k řešení potřeby cílené a spolehlivé nouzové komunikace v rámci ekosystémů profesionálních a privátních sítí, zejména pro služby kritické komunikace (Mission Critical). Před její standardizací organizace spoléhaly na méně integrované metody, jako jsou rádiové vysílání, hromadné [SMS](/mobilnisite/slovnik/sms/) nebo proprietární aplikace, kterým chybělo garantované doručení, podpora multimédií a integrace s komplety služeb kritické hlasové a video komunikace. Omezení těchto přístupů zahrnovala potenciální zahlcení sítě ovlivňující doručení, absenci potvrzení od uživatele a nemožnost využít správu skupin a mechanismy priority vlastní službám kritické komunikace 3GPP.
