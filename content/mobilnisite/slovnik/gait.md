...
GAIT, standardizovaný v 3GPP Release 7, definuje komplexní rámec interoperability pro dvou režimové mobilní stanice schopné fungovat na sítích GSM (Global System for Mobile Communications) i ANSI-136 (American National Standards Institute 136, známý také jako [TDMA](/mobilnisite/slovnik/tdma/) - Time Division [Multiple Access](/mobilnisite/slovnik/multiple-access/)). Architektura je založena na mobilní stanici podporující GAIT, která obsahuje dvojité rádiové transceivery a sofistikované protokolové zásobníky pro zvládnutí odlišných specifikací rádiového rozhraní, modulačních schémat a síťových signalizačních procedur obou systémů. Mezi klíčové komponenty patří dvou režimový modul identifikace účastníka ([SIM](/mobilnisite/slovnik/sim/)) podporující funkce GSM SIM a ANSI-136 [R-UIM](/mobilnisite/slovnik/r-uim/) (Removable User Identity Module) spolu s inteligentními algoritmy pro výběr sítě, které automaticky volí preferovaný systém na základě nastavení operátora, síly signálu a dostupnosti služeb.
