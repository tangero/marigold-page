...
C-RNTI je ústřední pro dynamické plánování. Pro každý přenosový časový interval (TTI) plánovač v základnové stanici používá C-RNTI k adresování povolení a přiřazení konkrétním UE. Používá se pro přenosy na sdílených kanálech pro uplink (UL-SCH) i downlink ([DL-SCH](/mobilnisite/slovnik/dl-sch/)). Identifikátor je dočasný a specifický pro buňku; pokud UE provede předání spojení (handover) do nové buňky, cílová buňka mu přidělí nové C-RNTI. Tím je zajištěna jedinečnost identifikátoru v oblasti pokrytí buňky a zjednodušena správa prostředků. C-RNTI je uvolněno při uvolnění [RRC](/mobilnisite/slovnik/rrc/) spojení UE nebo během procedur předání spojení.
...
Jeho zavedení, zejména při návrhu LTE, bylo motivováno potřebou vysoce dynamického, paketově plánovaného vzdušného rozhraní. Na rozdíl od systémů s přepojováním okruhů přidělují LTE a NR prostředky v řádu milisekund. Přenos plné identity UE (jako [IMSI](/mobilnisite/slovnik/imsi/) nebo S-TMSI) s každým plánovacím povolením by vytvořil obrovskou režii. C-RNTI poskytuje krátký, lokálně významný ukazatel, který minimalizuje režii na řídicím kanále a zároveň umožňuje vysokorychlostní plánování s nízkou latencí vyžadované pro širokopásmové datové služby.
