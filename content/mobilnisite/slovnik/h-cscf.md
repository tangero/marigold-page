...
Jejím hlavním účelem je sloužit jako kotvící bod domácí sítě pro řízení relací založené na [SIP](/mobilnisite/slovnik/sip/). To řeší problém, jak spravovat identitu předplatitele, profily služeb a spouštění aplikací škálovatelným a na síti nezávislým způsobem. Centralizací této logiky v domácí síti mohou operátoři udržovat kontrolu nad poskytováním služeb i při roamingu uživatelů. H-CSCF ve spolupráci se [S-CSCF](/mobilnisite/slovnik/s-cscf/) a I-CSCF poskytuje robustní rámec pro směrování SIP zpráv, vynucování bezpečnostních politik a integraci se širokým ekosystémem aplikačních serverů, čímž připravuje síť na budoucí multimediální aplikace.
