...
Primárním účelem Digital Pre-Distortion je překonání základního kompromisu mezi účinností a linearitou výkonového zesilovače. Výkonové zesilovače jsou nejúčinnější při provozu blízko saturace, ale tato oblast je vysoce nelineární, což způsobuje zkreslení signálu a spektrální zpětný růst, který ruší sousední kanály. Před rozšířeným přijetím DPD musely systémy 'ustupovat' s provozem zesilovače [PA](/mobilnisite/slovnik/pa/) do lineárnější, ale méně účinné oblasti, což plýtvalo značným množstvím stejnosměrného výkonu a zvyšovalo provozní náklady, zejména ve výkonných základnových stanicích.
