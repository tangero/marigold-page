...
Vytvoření konceptu N-PDU bylo motivováno zavedením GPRS, které vyžadovalo paketově orientovanou nadstavbu nad stávající spojově orientovanou sítí GSM. Poskytlo způsob, jak definovat datovou jednotku, která bude podléhat klíčovým funkcím síťové vrstvy, jako je komprese hlaviček (pro úsporu rádiových prostředků), šifrování (pro zabezpečení) a segmentace (pro přizpůsobení rámcům nižší vrstvy). Řeší omezení plynoucí z chápání uživatelských dat jako transparentního bitového toku tím, že umožňuje síťové vrstvě inteligentně zpracovávat a spravovat datovou jednotku pro optimální výkon a spolehlivost na heterogenní cestě od UE k externí paketové datové síti.
