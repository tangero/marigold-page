...
Mezi klíčové komponenty zapojené do AOC-D patří UE, které musí podporovat schopnosti prezentace AOC-D pro zobrazení poplatků uživateli; MSC nebo Call Session Control Function (CSCF) pro řízení relace a signalizaci; a účtovací systém (např. OCS nebo Charging Data Function (CDF)). Služba funguje tak, že účtovací systém vypočítá přírůstkové poplatky na základě dat o využití v reálném čase a instruuje uzel řízení relace, aby odeslal informaci do UE. Například u předplaceného hlasového hovoru OCS postupně odečítá kredit během hovoru a může spustit oznámení AOC-D, když kredit dosáhne varovných úrovní. Ve službách založených na IMS lze AOC-D implementovat pomocí zpráv SIP INFO nebo jako součást aktualizací Session Description Protocol (SDP), což umožňuje flexibilní integraci s multimediálními relacemi.
