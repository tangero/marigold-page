...
Jeho role v síťovém ekosystému je nepřímá, ale pro zajištění kvality klíčová. Poskytuje standardizovaný fyzický zdroj testovacích vektorů používaných při validaci implementací multimediální telefonie, paketově přepínané streamovací služby ([PSS](/mobilnisite/slovnik/pss/)) a multimediální vysílací/multicastové služby ([MBMS](/mobilnisite/slovnik/mbms/)). Tím, že 3GPP nařizuje použití konkrétního, široce dostupného fyzického formátu, zajišťuje reprodukovatelnost a přesnost testů shody pro dekódování médií, synchronizaci a parsování formátů souborů napříč různými zařízeními a síťovými elementy.
