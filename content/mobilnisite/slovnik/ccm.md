...
Vytvoření CCM bylo motivováno integrací infrastruktury veřejných klíčů (PKI) do mobilních sítí za účelem zvýšení bezpečnosti nad rámec tradiční autentizace založené na SIM kartě. Řeší problém, jak bezpečně a spolehlivě získat certifikát z důvěryhodného síťového zdroje do UE. To umožňuje širokou škálu bezpečnostních aplikací, včetně zabezpečení doručování obsahu založeného na [HTTP](/mobilnisite/slovnik/http/) (jak je uvedeno ve specifikacích jako 26.114), umožnění autentizace založené na certifikátech pro [GBA](/mobilnisite/slovnik/gba/) a podpory ochrany služeb pro vysílací služby. Poskytuje základní vrstvu zasílání zpráv, která operátorům umožňuje dynamicky nasazovat služby závislé na certifikátech.
