...
Architektonicky je MMSR součástí MMS uživatelského agenta (MMS [UA](/mobilnisite/slovnik/ua/)) na straně příjemce. Když je MMS zpráva odeslána, je nejprve předána do centra služby multimediálních zpráv (MMSC) prostřednictvím MMS uživatelského agenta odesílatele. MMSC následně upozorní MMSR zamýšleného příjemce na čekající zprávu, typicky prostřednictvím [WAP](/mobilnisite/slovnik/wap/) push přes řídicí kanál, jako je [SMS](/mobilnisite/slovnik/sms/). Po přijetí tohoto upozornění MMSR naváže datové spojení (např. přes paketové přenosy) a stáhne skutečný obsah zprávy z MMSC pomocí protokolů jako [HTTP](/mobilnisite/slovnik/http/) nebo WAP. MMSR musí podporovat potřebné kodeky a mediální formáty, aby mohla zobrazit přijatý multimediální obsah.
