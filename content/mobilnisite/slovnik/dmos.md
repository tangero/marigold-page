...
V rámci architektury 3GPP je DMOS sledován a hlášen jako součást rámce pro sběr měření kvality uživatelského zážitku (QoE) definovaného pro multimediální služby. UE nebo síťová sonda může měřit výkonnost doručování médií a pomocí standardizovaného modelu vypočítat DMOS. Tato data jsou pak nahlášena do sítě, často do funkce detekce provozu (TDF), funkce pravidel pro politiky a účtování (PCRF) nebo přímo do operačního systému operátora prostřednictvím funkce analýzy manažerských dat ([MDA](/mobilnisite/slovnik/mda/)).
