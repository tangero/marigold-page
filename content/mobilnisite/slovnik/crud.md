...
Předchozí přístupy v sítích 3GPP se silně spoléhaly na dodavatelsky specifická rozhraní a protokoly pro správu, které bránily multi-vendorové interoperabilitě a automatizaci. Standardizace CRUD operací prostřednictvím RESTful [API](/mobilnisite/slovnik/api/) sjednotila 3GPP s osvědčenými postupy v cloud computingu a webových službách, což usnadnilo integraci telekomunikačních sítí s [IT](/mobilnisite/slovnik/it/) systémy a cloudovými platformami. Tento přístup také usnadnil adopci DevOps praktik v síťových operacích, umožňujících průběžnou integraci a nasazování síťových funkcí a služeb.
