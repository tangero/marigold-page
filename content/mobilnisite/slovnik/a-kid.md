...
Identifikátor klíče [AKMA](/mobilnisite/slovnik/akma/) (A-KID) je kritický bezpečnostní parametr v rámci architektury 3GPP Authentication and Key Management for Applications (AKMA), zavedené ve verzi 16. Slouží jako jednoznačný odkaz nebo ukazatel na konkrétní aplikační klíč AKMA (K_AKMA), který je bezpečně vygenerován a uložen kotvící funkcí AKMA (AAnF) v domovské síti. A-KID je generován AAnF a je vázán na konkrétní UE a instanci AAnF, která K_AKMA vytvořila. Jeho struktura a použití jsou definovány v několika specifikacích 3GPP, včetně TS 33.535 pro procedury AKMA a TS 24.501 pro jeho přenos v signalizaci Non-Access Stratum ([NAS](/mobilnisite/slovnik/nas/)).

Z architektonického hlediska je A-KID generován AAnF po úspěšném primárním ověření UE (např. pomocí 5G [AKA](/mobilnisite/slovnik/aka/) nebo EAP-AKA'). Během tohoto procesu AAnF odvodí K_AKMA z kotvícího klíče vytvořeného při tomto ověření. AAnF následně vytvoří A-KID, který typicky obsahuje informace pro jednoznačnou identifikaci kontextu klíče, jako je SUPI UE, identifikátor AAnF (AAnF-ID) a případně index klíče nebo parametr aktuálnosti. Tento A-KID je pak poskytnut UE, často v rámci příkazu pro nastavení zabezpečení NAS nebo podobné procedury, což umožňuje UE jej uložit pro budoucí použití s aplikačními službami.

Když se UE chce připojit k aplikační službě s podporou AKMA (hostované aplikační funkcí, [AF](/mobilnisite/slovnik/af/)), předloží A-KID této AF jako součást žádosti o ověření služby. AF, která K_AKMA nedisponuje, použije tento A-KID k dotazování na správnou AAnF (identifikovanou uvnitř A-KID) přes referenční bod N33. AAnF žádost ověří, na základě A-KID načte odpovídající K_AKMA a odvodí aplikačně specifické klíče (jako K_AF), které pak bezpečně poskytne AF. Tento proces umožňuje AF a UE navázat zabezpečenou relaci pomocí klíčů zakořeněných v přihlašovacích údajích 3GPP, aniž by AF kdy musela manipulovat s dlouhodobým klíčem účastníka.
...
A-KID byl vytvořen k řešení problému zabezpečeného a škálovatelného ověřování pro služby aplikací třetích stran (jako streamování, IoT nebo podnikové služby), které chtějí využít silné, na předplatném založené ověření sítí 3GPP, aniž by se přímo integrovaly s uzly jádra sítě jako [UDM](/mobilnisite/slovnik/udm/)/[AUSF](/mobilnisite/slovnik/ausf/). Před [AKMA](/mobilnisite/slovnik/akma/) aplikace často spoléhaly na samostatné databáze přihlašovacích údajů (uživatelská jména/hesla, tokeny OAuth) nebo méně bezpečné metody, což vytvářelo tř[ec](/mobilnisite/slovnik/ece-c/)í plochy pro uživatele a správní zátěž pro operátory. Účelem A-KID je poskytnout klíčový prvek tohoto nového paradigmatu – zabezpečený, sítí vydaný identifikátor, který odemyká kryptograficky silné, sítí odvozené klíče pro aplikace.
