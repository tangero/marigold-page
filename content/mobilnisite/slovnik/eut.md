...
Označení EUT řeší omezení ad-hoc testovacích metodologií. Specifikuje přesně, co je testováno (např. RF přední část UE, nikoli celé zařízení včetně nebuněčných komponent), za jakých podmínek a s jakými rozhraními. Tato přesnost je klíčová pro testování pokročilých funkcí, jako je agregace nosných, [MIMO](/mobilnisite/slovnik/mimo/) a úsporné stavy napájení, kde musí být chování EUT přesně řízeno a měřeno, aby byla ověřena shoda se standardem.
