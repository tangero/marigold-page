...
Klíčové součásti fungování LMC zahrnují vazby jejích servisních rozhraní, bezpečnostní kontext pro ověřování a autorizaci polohových požadavků a její schopnost zpracovávat různé typy polohových služeb definované v 3GPP, jako je Mobile Terminated Location Request ([MT-LR](/mobilnisite/slovnik/mt-lr/)), Mobile Originated Location Request ([MO-LR](/mobilnisite/slovnik/mo-lr/)) a Network Induced Location Request (NI-LR). Její role je klíčová pro umožnění ekosystému polohových služeb 5G, zajišťující, že aplikace mohou spolehlivě a bezpečně přistupovat k polohovým datům UE při respektování předpisů na ochranu soukromí a síťových politik.
