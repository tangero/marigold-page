...
Koncept identifikátoru sítě (NI) byl vytvořen k vyřešení základního problému směrování datové relace mobilního uživatele do správné externí sítě škálovatelným a standardizovaným způsobem. V raných sítích [GPRS](/mobilnisite/slovnik/gprs/), když operátoři začali nabízet přístup k více externím sítím (např. podniková intranet, brána WAP a veřejný internet), byl potřebný mechanismus k rozlišení těchto cílů. Bez standardizovaného identifikátoru by byly vyžadovány proprietární konfigurace, což by bránilo interoperabilitě mezi UE a sítěmi od různých výrobců a operátorů.
