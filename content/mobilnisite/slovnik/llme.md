...
Logical Link Management Entity (LLME) je implementační komponenta, která vykonává funkce specifikované protokolem správy logického spoje (Logical Link Management, [LLM](/mobilnisite/slovnik/llm/)). Existuje jako softwarový nebo firmware modul v rámci protokolových zásobníků mobilní stanice ([MS](/mobilnisite/slovnik/ms/)) a podpůrného uzlu pro [GPRS](/mobilnisite/slovnik/gprs/) ([SGSN](/mobilnisite/slovnik/sgsn/)). LLME zajišťuje provádění LLM procedur, včetně správy spojů logického spojového řízení (Logical Link Control, [LLC](/mobilnisite/slovnik/llc/)). Zpracovává LLM zprávy, udržuje stavové automaty pro každý logický spoj a interaguje s dalšími entitami, jako je správa mobility GPRS ([GMM](/mobilnisite/slovnik/gmm/)) a správa relace ([SM](/mobilnisite/slovnik/sm/)), pro koordinaci aktivit spojů. LLME používá parametry, jako je dočasná identita logického spoje (Temporary Logical Link Identity, [TLLI](/mobilnisite/slovnik/tlli/)), k identifikaci a správě konkrétních kontextů logických spojů.

Z architektonického hlediska LLME funguje na rozhraní mezi podsložkou LLC a nižšími vrstvami, jako je RLC/MAC. V MS je LLME součástí protokolového zásobníku uživatelského zařízení, zatímco v SGSN je integrována do zpracování na síťové straně. Entita spravuje zřizování spojů iniciováním nebo odpovídáním na požadavky na aktivaci, které zahrnují vyjednávání profilů QoS a alokaci zdrojů. Během přenosu dat LLME dohlíží na údržbu spoje, včetně řízení toku, detekce chyb a dohledu prostřednictvím mechanismů, jako jsou keep-alive signály a obsluha časových limitů. Také zajišťuje procedury uvolňování spojů, což zahrnuje řádné uvolnění zdrojů a informací o kontextu při ukončení relace nebo v důsledku selhání.
