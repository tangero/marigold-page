...
Monitoring Event Charging Node (MECN) je funkční entita definovaná v rámci architektury 3GPP za účelem sběru, zpracování a hlášení monitorovacích událostí relevantních pro účtování. Nejde o samostatný fyzický uzel, ale o logickou funkci integrovanou do stávajících prvků jádra sítě, především Mobility Management Entity ([MME](/mobilnisite/slovnik/mme/)), Serving [GPRS](/mobilnisite/slovnik/gprs/) Support Node (SGSN) a Interworking SCEF ([IWK-SCEF](/mobilnisite/slovnik/iwk-scef/)). Jejím hlavním úkolem je sloužit jako zdroj podrobných informací o využití založených na událostech, které jsou předávány do offline a online účtovacích systémů ([OFCS](/mobilnisite/slovnik/ofcs/) a [OCS](/mobilnisite/slovnik/ocs/)). MECN monitoruje specifické aktivity uživatele a sítě, jako je zřízení relace, události mobility nebo využití služby, a generuje odpovídající Charging Data Records ([CDR](/mobilnisite/slovnik/cdr/)) nebo hlášení událostí. Tyto záznamy jsou následně předávány funkci Charging Data Function ([CDF](/mobilnisite/slovnik/cdf/)) nebo Online Charging Function ([OCF](/mobilnisite/slovnik/ocf/)) přes standardizovaná rozhraní, jako jsou referenční body Ga nebo Gy.
