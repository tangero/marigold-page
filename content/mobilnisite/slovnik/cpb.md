...
Historicky, jak se 3GPP vyvíjelo od Rel-11 dále, rostla poptávka po vysoce kvalitních video službách přes sítě LTE a později 5G, což si vyžádalo sofistikovanější nástroje pro video kódování. Zavedení CPB bylo motivováno potřebou podporovat pokročilé kodeky jako H.265/[HEVC](/mobilnisite/slovnik/hevc/) a později Versatile Video Coding ([VVC](/mobilnisite/slovnik/vvc/)), které nabízejí vyšší kompresi, ale vyžadují přesné řízení časování. Definováním parametrů CPB ve specifikacích, jako jsou 26.346 a 26.906, umožnilo 3GPP interoperabilní doručování videa napříč různými zařízeními a sítěmi, čímž řešilo omezení ad-hoc přístupů k vyrovnávací paměti, které vedly k problémům s kompatibilitou a suboptimálním výkonem.
