...
Role CAC přesahuje pouhou kontrolu prostředků a zahrnuje vynucování politik, diferenciaci služeb a ochranu příjmů. Tím, že CAC zabraňuje přetížení sítě, udržuje kvalitu služeb pro prémiové účastníky a kritické aplikace a zároveň zajišťuje spravedlivé přidělování prostředků všem uživatelům. V moderních sítích se CAC vyvinul tak, aby podporoval modely dynamického sdílení prostředků, řízení přístupu pro síťové segmenty a integraci s architekturami virtualizace síťových funkcí ([NFV](/mobilnisite/slovnik/nfv/)) a sítí definovaných softwarem ([SDN](/mobilnisite/slovnik/sdn/)). Mechanismus kontinuálně monitoruje stav sítě a může spustit modifikace relací nebo preventivní akce při zjištění omezení prostředků, čímž zajišťuje optimální výkon sítě při různých podmínkách zatížení.
