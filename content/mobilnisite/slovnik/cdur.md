...
Z architektonického hlediska CDUR generuje síťová funkce zodpovědná za monitorování události služby, typicky Call Session Control Function ([CSCF](/mobilnisite/slovnik/cscf/)) pro služby IMS, Serving [GPRS](/mobilnisite/slovnik/gprs/) Support Node ([SGSN](/mobilnisite/slovnik/sgsn/)) nebo Gateway GPRS Support Node (GGSN)/Packet Data Network Gateway ([PGW](/mobilnisite/slovnik/pgw/)) pro paketová data, nebo Mobile Switching Center ([MSC](/mobilnisite/slovnik/msc/)) pro okruhově spínané hovory. Tyto Charging Trigger Functions (CTF) detekují začátek a konec zpoplatnitelné události. CTF tyto události časově označí a vypočítá rozdíl, což vede k hodnotě CDUR. Tato doba trvání je pak zahrnuta do fakturačních informací odeslaných do Charging Data Function (CDF) pro offline účtování nebo použita pro odečítání kreditu v reálném čase s Online Charging System (OCF).
