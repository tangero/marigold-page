...
ICH byl vytvořen k řešení základního problému v UMTS založeném na WCDMA: jak efektivně a spolehlivě signalizovat vysoce proměnný přenosový formát vyhrazeného datového kanálu mobilnímu terminálu v reálném čase. WCDMA podporuje více simultánních služeb s různými datovými rychlostmi a požadavky na kvalitu na jediném spojení (multiplexování transportních kanálů). Přenosový formát se může měnit každých 10 ms rámec na základě okamžité poptávky po datech a rozhodnutí síťového plánování.
