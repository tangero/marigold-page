...
[ATM](/mobilnisite/slovnik/atm/) Adaptation Layer type 1 (AAL1) je specifický protokol přizpůsobovací vrstvy v rámci zásobníku protokolů ATM, standardizovaný [ITU-T](/mobilnisite/slovnik/itu-t/) a přijatý 3GPP pro určitá síťová rozhraní. Funguje jako mezivrstva mezi vrstvou ATM a aplikacemi vyšších vrstev a je speciálně navržen pro podporu služeb s konstantním přenosovým tokem ([CBR](/mobilnisite/slovnik/cbr/)), které vyžadují přesný časový vztah mezi zdrojem a cílem. Protokol je definován ve specifikaci 3GPP 29.163, která podrobně popisuje jeho implementaci pro interoperabilitu mezi IP sítěmi a legacy okruhově přepínanými sítěmi.
