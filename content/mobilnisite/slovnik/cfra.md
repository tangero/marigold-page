...
Dále bylo vytvoření CFRA motivováno potřebou podporovat pokročilé anténní systémy a beamforming v 5G. V síti využívající beamforming je spojení UE udržováno prostřednictvím specifických směrových beamů. Pokud beam selže, musí to UE rychle nahlásit gNB, aby přešlo na nový beam – proces známý jako obnova po selhání beamu ([BFR](/mobilnisite/slovnik/bfr/)). Použití CBRA pro BFR by bylo příliš pomalé a nespolehlivé. CFRA poskytuje rychlou cestu pro UE k odeslání žádosti BFR pomocí vyhrazené preambule, což umožňuje rychlou obnovu beamu a udržení vysokokvalitního spoje vyžadovaného pro frekvence milimetrových vln (mmWave) a služby URLLC. CFRA je tedy základním prvkem umožňujícím splnění výkonnostních cílů 5G.
