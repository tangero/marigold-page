...
Historický kontext zahrnuje snahu o [SON](/mobilnisite/slovnik/son/) a [MDT](/mobilnisite/slovnik/mdt/) v rámci 3GPP, jejichž cílem bylo snížit provozní náklady a zlepšit výkon sítě. NCR navazuje na dřívější funkce MDT tím, že umožňuje průběžné hlášení iniciované sítí, namísto spoléhání se pouze na měření spouštěná UE nebo ukládaná do logu. Tím řeší omezení předchozích metod, které často měly mezery v pokrytí dat nebo vyžadovaly spolupráci UE pouze během specifických událostí. NCR zajišťuje, že operátoři mají stabilní proud informací pro průběžnou optimalizaci.
