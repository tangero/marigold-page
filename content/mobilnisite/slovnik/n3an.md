...
N3AN byl vytvořen, aby řešil základní požadavek 5G na konvergovaný přístup. Před 5G byl přístup non-3GPP (především Wi-Fi) často považován za samostatnou síť druhé kategorie s omezenou integrací, využívající řešení jako S2a-based Trusted WLAN Access k EPC. To vedlo k nesourodým uživatelským zkušenostem, oddělenému ověřování a nemožnosti aplikovat konzistentní politiky a účtování na úrovni celulárních sítí. Systém 5G byl navržen od základů jako nezávislý na typu přístupu a N3AN je realizací tohoto principu pro důvěryhodné přístupy non-3GPP.
