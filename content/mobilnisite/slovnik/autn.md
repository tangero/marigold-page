...
V celkové síťové architektuře je AUTN součástí autentizačního vektoru ([AV](/mobilnisite/slovnik/av/)), typicky kvintetu (pro 3G/4G) nebo vektoru (pro 5G), který zahrnuje RAND, AUTN, XRES (Očekávaná odpověď), CK a IK. Tento vektor je generován AuC/[ARPF](/mobilnisite/slovnik/arpf/) (Autentizační úložiště a zpracovatelská funkce) a doručen uzlu obsluhující sítě (např. VLR/SGSN/[MME](/mobilnisite/slovnik/mme/)/[AMF](/mobilnisite/slovnik/amf/)). Obsluhující uzel poté přepošle RAND a AUTN k UE, aby zahájil výzvu. Role AUTN je tedy klíčová v počátečním handshake, který naváže důvěryhodný vztah před výměnou jakýchkoli uživatelských dat.
