...
Hlavním problémem, který EOC řeší, je koordinace zásahů více složek během složitých mimořádných událostí. Poskytuje jednotnou platformu pro příjem tísňových hovorů a dat, správu nasazení zasahujících jednotek a sdílení kritických informací v reálném čase. Díky využití standardů 3GPP zajišťuje, že komunikace při mimořádných událostech mohou bezproblémově fungovat napříč komerčními a vyhrazenými sítěmi veřejné bezpečnosti a podporovat pokročilé funkce, jako je vysílání videa vysoké kvality, sdílení dat a přesné lokalizační služby, které byly ve starších systémech, jako je [TETRA](/mobilnisite/slovnik/tetra/) nebo [P25](/mobilnisite/slovnik/p25/), omezené.
