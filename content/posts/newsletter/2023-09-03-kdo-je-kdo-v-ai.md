...
Jako každý úspěšný šéf si i Sam Altman dovoluje rozptylující vedlejší projekt. V jeho případě jde o Worldcoin a jeho World ID. To Altman popisuje jako "digitální pas", jenž má prokázat, že jeho držitel je skutečný člověk, nikoliv bot s umělou inteligencí. Pro získání průkazu World ID se zákazník zaregistruje a provede osobní sken oční duhovky pomocí "koule" Worldcoin, stříbrné koule o velikosti přibližně bowlingové koule. Jakmile sken oční duhovky na kouli ověří, že se jedná o skutečného člověka, vytvoří World ID. World ID mají být nezbytné v době generativních chatbotů s umělou inteligencí, jako je ChatGPT, kteří vytvářejí díla podobná lidským. World ID by se mohly používat k rozlišení skutečných lidí od botů s umělou inteligencí na internetu a podle Altmana může být základem budoucí infrastruktury umožňující například i UBI, Univerzální základní příjem, jenž podle Altmana souvisí s univerzální umělou inteligencí. 

Sam Altman narozený v roce 1985 studoval jeden ročník počítače na Stanfordu, ze školy ale odešel bez titulu, je vegetarián, gay a prepper. Magazín Forbes jej nejnověji zařadil na seznam stovky nejvlivnějších lidí světa. Firma OpenAI má hodnotu kolem 27 miliard dolarů. 
...
V roce 2011 Ng založil ve společnosti Google projekt Google Brain, který vyvíjel rozsáhlé umělé [[neuronové sítě](/ai/neuronove-site/)](/ai/neuronove-site/) s využitím distribuované výpočetní infrastruktury společnosti Google. Mezi jeho významné výsledky patří [[neuronová síť](/ai/neuronove-site/)](/ai/neuronove-site/) vycvičená pomocí algoritmů hlubokého učení na 16 000 procesorových jádrech, která se naučila rozpoznávat kočky pouze po zhlédnutí videí na YouTube, aniž by jí někdo řekl, co je to "kočka". To už je dneska klasika, ale tehdy naučil učící algoritmy se skutečně učit. 

Následně působil Ng od roku 2014 jako předseda skupiny Baidu AI Group, kde stál v čele kritických projektů v oblasti umělé inteligence. Jeho vedení v této funkci významně přispělo k tomu, že se společnost Baidu stala globálním lídrem v oblasti umělé inteligence. Pro společnost také vyvinul platformu umělé inteligence nazvanou DuerOS a další technologie, které Baidu posunuly před Google v diskurzu a vývoji umělé inteligence.

Mezi Ngovy přínosy se počítají četné, dnes již klasické a samozřejmé inovace. Byl například jednim z prvních, kdo pro AI výpočty začal používat grafické procesory. Dnes propaguje přechod na platformu HPC. Publikoval či je spoluautorem více jak 200 vědeckých článků o AI, ML a robotice. 

Andrew Ng se narodil v roce 1976 ve Velké Británii, jeho manželkou je Carol Reiley, významná výzkumnice v oblasti autonomní robotiky, podnikatelka a dnes šéfka medicínského AI starutpu. Má s ní dvě děti. 
...
Daniela Amodei je známá svým úzkým poutem s bratrem Dariem Amadeiem. Jejich pouto se přeneslo i do profesního života. Dario Amadei je spoluzakladatelem a generálním ředitelem společnosti Anthropic, vystudoval fyziku na Stanfordu, získal doktorát z biofyziky na Princetonu a má bohaté zkušenosti v oblasti výzkumu a umělé inteligence. V OpenAI Dario pracoval v letech 2016-2020 a dohlížel na vytvoření jazykových modelů GPT-2 a GPT-3 společnosti.

Sourozenci Amodeiovi se zabývají právě tím, že modely umělé inteligence zůstávají navzdory svému obrovskému potenciálu do značné míry nepřehledné a obtížně pochopitelné. Proto se rozhodli pracovat na zlepšení našeho porozumění těmto systémům umělé inteligence. Chatbot společnosti s názvem Claude je podobný ChatGPT společnosti OpenAI, ale je vycvičen technikou označovanou jako "ústavní AI", která stanovuje zásady, jako je výběr odpovědí, které jsou podle společnosti "nejméně rasistické a sexistické" a podporují život a svobodu. 

Kromě vývoje "algoritmu nové generace" pro svého chatbota Claude Anthropic usilovně pracuje na získávání kapitálu. Nedávno získala 450 milionů dolarů od sponzorů včetně společností Google, Salesforce a Zoom Ventures. Nicméně je třeba poznamenat, že dřívější kolo financování ve výši 580 milionů dolarů, které Anthropic získal, vedla společnost Alameda Research Ventures padlého krypto-podnikatele podvodníka Sama Bankmana-Frieda. 

Daniela Amodeiová získala bakalářský titul na Kalifornské univerzitě v Santa Cruz v oboru anglická literatura, politika a hudba. Paradoxní je, že její rok narození se mi nepodařilo dohledat... 
...
Společnost se podílela na vytvoření AI modelu Stable Diffusion pro převod textu na obrázek. Pro Mostaquea je prioritou udržet model s otevřeným zdrojovým kódem a bez zábran, které by omezovaly, jaký obsah může model generovat. Později, ve snaze učinit umělou inteligenci Stability komerčně atraktivnější trénoval verzi Stable Diffusion na souboru dat, který byl filtrován tak, aby z něj byly odstraněny pornografické obrázky. 
