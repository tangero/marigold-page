...
- Joel Mokyr
summary_points:
- Joel Mokyr z Northwestern University získal Nobelovu cenu za ekonomii 2025
- Oceněn za výzkum primárního významu inovací pro moderní ekonomický růst
- Jeho práce je kvalitativní, založená na historických studiích místo statistických modelů
- Argumentuje, že průmyslová revoluce vznikla z myšlenek, nikoliv materiálních faktorů
- Rozlišuje makro-invence (převratné objevy) a mikro-invence (postupná zlepšení)
- Zdůrazňuje význam propojení teoretických a praktických znalostí
---
