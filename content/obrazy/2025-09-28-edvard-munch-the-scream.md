...
title: "Edvard Munch - Výkřik / The Scream"
date: 2025-09-28
order:
namalovano: 1893
autor: "Edvard Munch"
obraz: Výkřik
styl: expresionismus
urlobrazu: "/assets/obrazy/edvard-munch-the-scream.jpg"
---
Výkřik je jedním z nejrozpoznatelnějších obrazů všech dob, zachycující křičící postavu na mostě v Oslo. Munch vytvořil tento obraz jako vyjádření existenciální úzkosti a moderní alienace, která rezonuje s diváky dodnes.

## 🖼️ Kde dílo vidět
Národní galerie v Oslo, Norsko (existuje několik verzí)

## Edvard Munch
- 🗓️ **Narozen/a:** 1863-1944
...
![Výkřik](/assets/obrazy/edvard-munch-the-scream.jpg)

## 🎨 O obraze Výkřik - The Scream
...
- 🖋️ **Styl:** Raný expresionismus s vlnitými liniemi a intenzivními, nerealistickými barvami
...
- 🌃 **Nálada:** Existenciální úzkost, osamění, psychologické napětí

## Historický kontext

Obraz vznikl na konci 19. století, kdy se v umění objevoval symbolismus a raný expresionismus. Munch vytvořil dílo jako reakci na moderní život a rostoucí pocit alienace v industrializované společnosti.
