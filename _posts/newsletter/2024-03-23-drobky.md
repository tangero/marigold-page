...
summary_points:
- Midjourney nově umožňuje používat stejnou tvář na více vygenerovaných fotografiích
  pomocí parametru --cref.
- Elon Musk opensourcuje LLM Grok, což má pomoci v konkurenčním boji.
- Pulitzerova cena nově vyžaduje zveřejnění použití AI, pět finalistů ji přiznalo.
- Google představil VLOGGER, framework pro generování fotorealistických videí mluvících
  osob ze zvuku.
title: "Drobky"
---
