...
V roce 2011 Ng založil ve společnosti Google projekt Google Brain, který vyvíjel rozsáhlé umělé [neuronové sítě](/ai/neuronove-site/) s využitím distribuované výpočetní infrastruktury společnosti Google. Mezi jeho významné výsledky patří [neuronová síť](/ai/neuronove-site/) vycvičená pomocí algoritmů hlubokého učení na 16 000 procesorových jádrech, která se naučila rozpoznávat kočky pouze po zhlédnutí videí na YouTube, aniž by jí někdo řekl, co je to "kočka". To už je dneska klasika, ale tehdy naučil učící algoritmy se skutečně učit. 
