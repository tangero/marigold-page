...
Nvidia má zavedenou plnou trasovatelnost všech procesorů podle výrobního čísla. Ví, komu co prodává a kontroluje si, zda u něj technologie také skončila. Když v létě do Česka dorazil bezpečnostní tým Nvidia včetně jednoho z nejvyšších šéfů společnosti, v serverovně, která měla být po strop naplněná Nvidia DGX H100, nebylo zde po AI procesorech ani památky. 
