...
summary_points:
- Meta vydala tři nové open source modely Llama 4 s různými parametry a schopnostmi.
- Llama 4 nabízí kontextové okno 10 milionů tokenů, což je 10x více než Google Gemini.
- Modely využívají architekturu iRoPE pro efektivní práci s extrémně dlouhým kontextem.
- Nová licence Llama 4 obsahuje omezení pro velké společnosti a požadavky na označování.
