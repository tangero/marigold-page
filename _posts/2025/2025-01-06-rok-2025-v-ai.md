...
summary_points:
- AI bude v roce 2025 všudypřítomná a nezbytná, podobně jako elektřina nebo internet.
- AGI (univerzální AI) v roce 2025 nenastane, ale vývoj AI bude i nadále prudce pokračovat.
- AI ovlivní pracovní procesy, ale v češtině bude dopad zpožděný o cca dva roky.
- Agenti a mikroagenti budou buzzwordem roku 2025 v AI, ale plného rozvoje nedosáhnou.
...
Nastoupí gigantická kontextová okna, byť ze začátku jen pro velmi drahé modely. Některé modely dosáhnou 10+ milionů [tokenů](/ai/[tokeny](/tokeny/)-versus-slova/) jako kontextového rozsahu, čímž si „zapamatují“ ohromné objemy dat. Tato „téměř neomezená paměť“ umožní sofistikované analýzy a odpovídání. Význam to má hlavně pro nestrukturovaná nebo nejasně strukturovaná data, jimž je potřeba porozumět "holisticky", tedy s trochou doteku magie ...
...
Shrnuto: V roce 2025 se očekává **výrazný posun od velkých jazykových modelů k menším, specializovaným modelům**, které jsou **efektivnější pro konkrétní úkoly**. Důraz bude kladen na **multimodální AI**, **agentickou AI**, a **zlepšení interpretovatelnosti a kontroly LLM**. **Zpracování velkých dat** a **vývoj nových architektur**, jako jsou tekuté [neuronové sítě](/ai/neuronove-site/), také hrají klíčovou roli v technologickém pokroku. **AI se stává součástí hardwaru** a **umožňuje lokální spouštění modelů** pro rychlejší a efektivnější zpracování dat.
