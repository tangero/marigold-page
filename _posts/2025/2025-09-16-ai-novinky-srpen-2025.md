...
- Baidu
layout: post
post_excerpt: Týden přinesl  velké novinky - Replit Agent 3 s autonomií 200 minut, Seedream 4.0 s 4K výstupem za 1,8 sekundy a první AI ministr v Albánii.
summary_points:
- Replit spustil Agent 3 s autonomním vývojem až 200 minut
- ByteDance představil Seedream 4.0 pro generování 4K obrázků
- UAE vydaly open-source model K2-Think s výkonem GPT-5
- ElevenLabs umožňuje úpravu hlasů podle věku a pohlaví
- Albánie jmenovala prvního AI ministra na světě
- Anthropic přidal vytváření souborů přímo v Claude
