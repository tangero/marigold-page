...
- Lights On
layout: post
post_excerpt: Projekt OpenEuroLLM vznikl jako evropská iniciativa pro vývoj otevřených
  velkých jazykových modelů (LLM) s cílem posílit technologickou suverenitu a konkurenceschopnost
...
Iniciativy OpenEuroLLM se účastní celkem 20 evropských institucí, firem a výpočetních center. Mezi hlavní účastníky patří:
Výzkumné instituce a univerzity
- Univerzita Karlova (Česká republika) - koordinátor projektu
- Technická univerzita v Eindhovenu (Nizozemsko)
Společnosti
- Aleph Alpha (Německo)
