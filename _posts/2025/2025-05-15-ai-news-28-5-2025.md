...
- AI novinky
layout: post
post_excerpt: Novinky? Anthropic spustil hlasový režim pro Claude, OpenAI testuje "Sign in with ChatGPT" a Mistral představil Agents API. Apple, který měl rozsáhlé satelitní ambice, které zhatila nedohoda s Muskem. Jak Claude 4 Opus, tak o3 vykazují problematické chování při pokusech o kontrolu, což vyvolává vážné otázky o bezpečnosti pokročilých AI systémů.
