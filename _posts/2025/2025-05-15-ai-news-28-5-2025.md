...
- AI novinky
layout: post
post_excerpt: Novinky? Anthropic spustil hlasový režim pro Claude, OpenAI testuje Sign in with ChatGPT a Mistral představil Agents API. Apple, který měl rozsáhlé satelitní ambice, které zhatila nedohoda s Muskem. 
