...
post_excerpt: "Jak vypadá samotné jádro mobilní sítě, v němž se dějí veškerá ta kouzla, jako je autorizace uživatele, přenosy a účtování jeho hovorů a dat a všechny další služby do okamžiku, než je převezme základnová stanice a pošle na mobilní telefon uživatele?"
layout: post
