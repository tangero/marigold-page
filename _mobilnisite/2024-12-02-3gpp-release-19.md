...
- **NTN**: Neterestriální sítě využívají satelity nebo vysoké stratosférické platformy pro zajištění připojení ve vzdálených oblastech. Release 19 přináší další parametry pro konfiguraci satelitních nákladů a podporu regenerativních nákladů na satelitech, což umožňuje větší flexibilitu při nasazení NTN.
...
Významnou součástí Release 19 je práce na využití nových frekvenčních pásem a zvýšení spektrální efektivity:

- Standardizace využití sub-THz pásem (nad 100 GHz)
- Implementace pokročilých modulačních schémat pro vysokofrekvenční přenosy
- Optimalizace carrier aggregation pro nová frekvenční pásma
- Vylepšení technik pro dynamic spectrum sharing
...
Release 19 integruje AI a strojové učení (ML) do správy rádiových sítí a sítí obecně.

- **AI/ML pro NG-RAN**: 3GPP se zaměří na využití umělé inteligence a strojového učení pro zlepšení výkonu sítě, včetně řízení přenosu a zpracování signálu, což umožní lépe optimalizovat výkon a efektivitu.
