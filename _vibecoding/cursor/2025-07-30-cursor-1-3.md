...
- terminál
layout: post
  post_excerpt: Cursor 1.3 přináší sdílený terminál s AI agentem, zobrazení využití kontextu v chatu a výrazně rychlejší úpravy kódu s optimalizacemi výkonu.
  summary_points:
- AI agent nyní používá nativní terminál uživatele pro provádění příkazů
- Chat zobrazuje využití kontextového okna na konci konverzace
- Search & Replace úpravy jsou rychlejší o 25%, Apply edits o 11%
- Odebrán Manual mode z chatu ve prospěch jednodušší navigace
title: Novinky v Cursor 1.3
---
