...
description: Amazon plánuje provést dva starty satelitů pro vysokorychlostní internet
  Kuiper v průběhu několika dní.
importance: 4
layout: tech_news_article
original_title: 'Rocket Report: Keeping up with Kuiper; New Glenn’s second flight
  slips - Ars Technica'
publishedAt: '2025-09-26T12:45:58+00:00'
slug: rocket-report-keeping-up-with-kuiper-new-glenns-se
source:
  emoji: 🔬
  id: ars-technica
  name: Ars Technica
...
Amazon plánuje provést dva starty satelitů pro vysokorychlostní internet Kuiper v průběhu několika dní.
