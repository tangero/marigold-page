...
description: Tento test využívá AI k třídění vašich účtenek, snímků obrazovky, identifikačních
...
Tento test využívá AI k třídění vašich účtenek, snímků obrazovky, identifikačních dokumentů a poznámek do specifických složek.
