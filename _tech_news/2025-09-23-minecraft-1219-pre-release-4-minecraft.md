...
description: 'Minecraft 1.21.9 Pre-Release 4
  ...
  - Oprava chyby, kdy se hráč mohl dostat do nekonečné smyčky při použití /kill příkazu

  - Oprava chyby, kdy se některé entity nesprávně zobrazovaly

  - Vylepšení stability a výkonu serveru'
importance: 3
layout: tech_news_article
original_title: Minecraft 1.21.9 Pre-Release 4 - Minecraft
publishedAt: '2025-09-23T15:27:48+00:00'
slug: minecraft-1219-pre-release-4-minecraft
source:
  emoji: 📰
  id: null
  name: Minecraft.net
title: Minecraft 1.21.9 předběžné vydání 4 - Minecraft
url: https://www.minecraft.net/en-us/article/minecraft-1-21-9-pre-release-4
