...
- 3GPP Release 16 - 5G New Radio, zcela propracovaný koncept obsahující také rozšířené MIMO, beamforming a Dynamic Spectrum Sharing DSS. Dále je tu Integrovaný přístup k backhaulu IAB, [vRAN](/item/c-ran_vran_open_ran/), podpora IoT a V2X
