...
Po tokenizaci je každý [token](/ai/tokeny-versus-slova/) převeden na numerickou reprezentaci pomocí velkého vyhledávacího slovníku, kde každý token má přiřazené unikátní číslo.
