...
- [Anychat](https://www.anychat.ai/) - použití jakéhokoliv AI modelu na jednom místě
...
- [Overlap Opus](https://www.overlap.ai/) - přeměna dlouhých videí na krátké virální klipy pomocí AI
- [Persona](https://www.persona.ai/) - nástroj pro tvorbu AI agentů pro tvůrce
...
- [Wispr Flow](https://www.wisprflow.com/) - AI hlasový diktát, který převádí váš hlas na text v jakékoliv aplikaci
...
- [Cubby](https://www.cubby.co/) - AI pracovní prostředí vytvořené pro kolaborativní výzkum
- [Cora](https://www.cora.ai/) - AI e-mailový asistent pro organizaci doručené pošty a automatizaci odpovědí
...
- [Particle](https://particle.news/) - AI zpravodajská aplikace kombinující více článků do sumarizovaných příběhů
...
- [Ash](https://www.ash.ai/) - personalizovaný AI poradce / kouč
