...
<div id="mindmap" style="min-height: 500px; width: 100%; border: 1px solid #eee; margin: 20px 0;"></div>
...
<script type="module">
  // Asynchronní načtení závislostí
  async function loadDependencies() {
    await Promise.all([
      loadScript('https://cdn.jsdelivr.net/npm/d3@7/dist/d3.min.js'),
      loadScript('https://cdn.jsdelivr.net/npm/markmap-view@0.15.5/dist/index.min.js')
    ]);
    initializeMarkmap();
  }

  // Helper pro načtení skriptu
  ...
  // Inicializace mindmapy
  function initializeMarkmap() {
    try {
      const source = document.getElementById('markmap-source').value;
      console.log('Načítám source...'); // Debug log
      
      if (!window.markmap) {
        console.error('Markmap knihovna není načtena');
        return;
      }
      ...
      console.log('Mindmapa vytvořena'); // Debug log
      ...
      console.error('Chyba při vytváření mindmapy:', error);
    }
  }

  // Spustit načítání po načtení DOMu
