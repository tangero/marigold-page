...
<div id="mindmap" style="min-height: 200px; width: 100%;"></div>
...
{% raw %}
<script>
// Kontrola, zda již byly skripty načteny
if (typeof window.markmap === 'undefined') {
    // Načtení potřebných skriptů
    ...
    Promise.all([
        ...
        loadScript('https://cdnjs.cloudflare.com/ajax/libs/markmap-view/0.15.5/index.min.js')
    ]).then(() => {
        initializeMarkmap();
    });
} else {
...
function initializeMarkmap() {
    ...
    Markmap.create('#mindmap', null, source);
}
</script>
{% endraw %}
...
Zde můžete pokračovat v psaní běžného obsahu...